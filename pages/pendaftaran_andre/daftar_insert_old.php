		...
		if ($_POST['idmr'] == "") {
			...
			if ($_POST['kd_poli'] == 'LANGSUNG') {
				...
				if ($_POST['medis'] == 'SKS') {
					...
					$insert = $db->query("insert into  tbl_pendaftaran (no_daftar, nomr, kd_poli, status_pasien, tgl_daftar, kode_perusahaan, nama_perusahaan, biayaAdmin, kode_dokter) values ('".$_POST['no_daftar']."', '".$_POST['nomr']."', '".$_POST['medis']."', 'OPEN', '".date("Y-m-d")."', '".$perusahaan_kode."', '".$perusahaan."', '".$biayaAdmin."', '".$_POST['kd_dokter']."')", 0);
				}
				else {
					$insert = $db->query("insert into  tbl_pendaftaran (no_daftar, nomr, kd_poli, status_pasien, tgl_daftar, kode_perusahaan, nama_perusahaan, biayaAdmin, kode_dokter) values ('".$_POST['no_daftar']."', '".$_POST['nomr']."', '".$_POST['medis']."', 'OPEN', '".date("Y-m-d")."', '".$perusahaan_kode."', '".$perusahaan."', '".$biayaAdmin."', '".$_POST['medis']."')", 0);
				}
				...
				$insert = $db->query("insert into  tbl_pendaftaran (no_daftar, nomr, kd_poli, status_pasien, tgl_daftar, kode_perusahaan, nama_perusahaan, biayaAdmin, kode_dokter) values ('".$_POST['no_daftar']."', '".$_POST['nomr']."', '".$_POST['kd_poli']."', 'OPEN', '".date("Y-m-d")."', '".$perusahaan_kode."', '".$perusahaan."', '".$biayaAdmin."', '".$_POST['kd_dokter']."')", 0);
			}			
