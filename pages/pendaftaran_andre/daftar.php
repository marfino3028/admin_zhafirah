    ...
    <div align="left">
        <table border="1" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#000000">
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px; width: 500px; overflow: inherit">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="500" bordercolor="#000000">
                        ...
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
							<!--- SELECT 2 ELEMENT---><input type="text" id="nomr" onchange="CariPasien(this.value)" style="width: 210px" >
                            </div></td>
                        </tr>
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">Hubungan</span></td>
                            <td valign="middle" align="center" colspan="2">
                            <div style="margin-bottom: 4px; margin-top: 4px;" id="langsung_hub">
                            &nbsp;
                            </div></td>
                        </tr>
                        <tr height="28">
