...
if(isset($_GET['id'])) {
    ...
    $query_surat = mysqli_query($con, "SELECT * FROM surat_rekomendasi WHERE id_surat = '$id'");
...
<div class="content">
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="text-white pb-2 fw-bold"><?php echo isset($surat) ? 'Edit' : 'Tambah'; ?> Data Surat Rekomendasi</h2>
                    <h5 class="text-white op-7 mb-2">Kelola Data Surat Rekomendasi</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page-inner mt--5">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="list_surat_rekomendasi.php">Data Surat Rekomendasi</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo isset($surat) ? 'Edit' : 'Tambah'; ?> Data Surat Rekomendasi</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <a href="list_surat_rekomendasi.php" class="btn btn-warning">
                    <i class="fas fa-arrow-left"></i> Kembali
                </a>
                <button type="button" class="btn btn-primary" onclick="document.getElementById('formSurat').submit();">
                    <i class="fas fa-save"></i> Tambah Surat Rekomendasi
                </button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="proses_surat_rekomendasi.php" method="post" id="formSurat">
                            ...
                            <!-- Section: Data Surat Rekomendasi -->
                            <div class="section-header text-center mb-4 p-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px;">
                                <h4 class="mb-0" style="font-weight: 600;">Data Surat Rekomendasi</h4>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="nomor_dokumen" id="nomor_dokumen"
                                           value="<?php echo isset($surat->nomor_dokumen) ? $surat->nomor_dokumen : 'SR-032200/PT.TWH/1710/2025'; ?>" 
                                           placeholder="SR-032200/PT.TWH/1710/2025" required readonly style="background-color: #e9ecef;">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kantor Imigrasi <span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="kantor_imigrasi" 
                                           value="<?php echo isset($surat->kantor_imigrasi) ? $surat->kantor_imigrasi : ''; ?>" 
                                           placeholder="Masukkan kantor imigrasi" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Catatan Surat Rekomendasi</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="catatan_surat" rows="4" 
                                              placeholder="Masukkan catatan surat rekomendasi (opsional)"><?php echo isset($surat->catatan_surat) ? $surat->catatan_surat : ''; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    <a href="list_surat_rekomendasi.php" class="btn btn-secondary">
