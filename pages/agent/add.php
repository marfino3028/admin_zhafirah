...
$kode=$_POST['kode_agent'];
$nik=$_POST['nik'];
$nama=$_POST['nama_agent'];
$kontak=$_POST['kontak'];
$email=$_POST['email']??'';
...
if($foto){
$target="uploads/agent/".time()."_".$foto;
move_uploaded_file($_FILES['foto']['tmp_name'],$target);
}
$db->query("INSERT INTO tbl_agent(kode_agent,nik,nama_agent,kontak,email,kota_kabupaten,jenis_kelamin,tanggal_lahir,status,alamat,catatan,foto)VALUES('$kode','$nik','$nama','$kontak','$email','$kota','$jk','$tgl_lahir','$status','$alamat','$catatan','".($foto?$target:'')."')");
echo'<script>alert("Data berhasil disimpan");window.location="?mod=agent&submod=list"</script>';
}
?>
<style>
...
<div class="form-title">Data Pribadi Agent</div>
<form method="POST" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
<label class="form-label">Kode Agent <span style="color:red">*</span></label>
<input type="text" name="kode_agent" class="form-control" placeholder="A-" required>
</div>
<div class="col-md-6">
<label class="form-label">NIK Agent <span style="color:red">*</span></label>
<input type="text" name="nik" class="form-control" required>
</div>
<div class="col-md-6">
<label class="form-label">Nama Agent <span style="color:red">*</span></label>
<input type="text" name="nama_agent" class="form-control" required>
</div>
<div class="col-md-6">
<label class="form-label">Kontak Agent <span style="color:red">*</span></label>
...
<div class="col-md-6">
<label class="form-label">Status Agent <span style="color:red">*</span></label>
...
<div class="col-md-12">
<label class="form-label">Catatan Agent</label>
...
<div class="col-md-4">
<div class="form-section">
<div class="form-title">Foto Agent ℹ️</div>
