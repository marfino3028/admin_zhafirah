<?php
$sub = $db->query("select * from tbl_karyawan where id='" . $_GET['id'] . "'");
    $t1 = explode("/", $_POST['tgl_exp']);
    $date1 = $t1[2] . '-' . $t1[0] . '-' . $t1[1];
    $t2 = explode("/", $_POST['tgl_lahir']);
    $date2 = $t2[2] . '-' . $t2[0] . '-' . $t2[1];
    $t2 = explode("/", $_POST['TGL_MASUK']);
//$sub[0]['TGL_MASUK'] = $t1[1] . '/' . $t1[2] . '/' . $t1[0];
?>
	...
	<form id="form_karyawan" method="POST" class='form-horizontal form-bordered' enctype="multipart/form-data" >
		<div style="padding-top: 20px;">
            <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#000000">
                <tr height="28">
                    ...
                    <td valign="middle" align="left">
                        <div style="margin-bottom: 4px; margin-top: 4px;"><input type="text" id="nip" name="nip" class="field text small" value="<?php echo $sub[0]['nip'] ?>" style="width: 100px;"></div></td>
                 ...
                 <tr height="28">
                    ...
                    <td valign="middle" align="left">
                        <div style="margin-bottom: 4px; margin-top: 4px;">
                            <input type="text" id="tgl_exp" name="tgl_exp" class="field text" class="form-control datepick" style="width: 70px;" value="<?php echo $sub[0]['tgl_exp'] ?>" /> &nbsp; mm/dd/yyyy &nbsp; <input type="checkbox" id="tgl_exp_su" name="tgl_exp_su" class="field text large" value="<?php echo $sub[0]['tgl_exp_su'] ?>" style="width: 50px;" />Seumur Hidup
                        </div></td>
                </tr>
                <tr height="28">
                    ...
                    <td valign="middle" align="left">
                        <div style="margin-bottom: 4px; margin-top: 4px;">
                            <input type="text" id="tempat_lahir" name="tempat_lahir" class="field text small" value="<?php echo $sub[0]['tempat_lahir'] ?>" /> &nbsp; <input type="text" id="tgl_lahir" name="tgl_lahir" class="field text" style="width: 70px;" value="<?php echo $sub[0]['tanggal_lahir'] ?>" /> &nbsp; mm/dd/yyyy
                        </div></td>
                </tr>
                <tr height="28">
                    ...
                    <td valign="middle" align="left">
                        <div style="margin-bottom: 4px; margin-top: 4px;">
                            <select tabindex="3" class="field select" name="lantai" id="lantai" > 
                                <?php
                ...
                <tr height="28">
                    <td width="200"><span style="margin-left:10px">Ganti Foto</span></td>
                    <td valign="middle" align="left">
                        <div style="margin-bottom: 4px; margin-top: 4px;">
            ...
            <div class="form-actions col-sm-offset-2 col-sm-10">
                <input type="input" id="id" name="id" value="<?php echo $sub[0]['id'] ?>" />
                <button type="button" class="btn btn-primary" name="simpan" id="simpan" onclick="simpanData(this.form, 'pages/master/employe_update.php')">Simpan Data</button>
            </div>
		</div>
	</form>	
	</div>
