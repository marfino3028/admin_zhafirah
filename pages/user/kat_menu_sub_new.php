...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Master Kategori Menu</div>
           ...
           <tr height="28">
                ...
                <div align="left">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#000000">
                        ...
                        <tr height="28">
                            <td width="200"><span style="margin-left:10px">Nama Ketegori Sub Menu</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            <input type="text" id="nm_ka_menu" name="nm_ka_menu" class="form-control" />
                            </div></td>
                        </tr>
                        <tr height="28">
    ...
    <div align="center" style="margin-right: 15px; margin-top: 10px; margin-bottom: 10px;">
        <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Master Kategori Menu" onclick="simpanData(this.form, 'pages/user/kat_sub_menu_insert.php')" />
    </div>
</form>
</div>
