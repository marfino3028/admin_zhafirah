                ...
                <div class="box-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box box-color box-bordered box-small blue">
                                ...
                                <div class="box-content nopadding">
                                    <form method="post" action="pages/user/user_insert.php" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
						...
						<select id="status_demo" name="status_demo" class='chosen-select form-control'>
						    ...
						    <option value="REGULER">Akun Reguler</option>
						    <option value="DEMO">Akun Demo</option>
						    <option value="DOKTER">Akun Dokter</option>
						    <option value="MCU">Akun MCU</option>
						</select>
                                            </div>
						...
						<select id="dokter" name="dokter" class='chosen-select form-control'>
							...
							?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" id="userid" name="userid" class="form-control" Placeholder="User ID" required="required" />
                                            </div>
                                            <label for="textfield" class="control-label col-sm-2" style="text-align: right;">Berlaku Hingga</label>
                                            <div class="col-sm-3">
                                                <input type="date" id="berlaku" name="berlaku" class="form-control" value="<?php echo date("Y-m-d")?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="textfield" class="control-label col-sm-2">NIP/NIK & Telp</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="nip" name="nip" class="form-control" Placeholder="NIP/NIK" required="required" />
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" id="telp" name="telp" class="form-control" Placeholder="Telp WA" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="textfield" class="control-label col-sm-2">Nama & Email</label>
                                            <div class="col-sm-5">
                                                <input type="text" id="nama" name="nama" class="form-control" required="required" Placeholder="Nama" />
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" id="email" name="email" class="form-control" required="required" Placeholder="Alamat Email" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div> 
                                                <label class="form-label margin-bottom-2xs" for="input-password">Password</label>
