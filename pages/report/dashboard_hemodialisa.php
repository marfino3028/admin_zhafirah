<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Dashbaord Stock Cosumble / BHP Hemodialisa</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Dashbaord Stock Cosumble / BHP Hemodialisa
                    </h3>
                </div>
                <div class="box-content">
                    <div style="text-align: left; margin-left: 10px; margin-top: 0px; margin-bottom: 10px;">
                        ...
                        &nbsp;&nbsp;
                        <input type="submit" class="btn btn-darkblue rounded" value=" Grafik!! "  onclick="GrafikLaporan()"  />
                        &nbsp;&nbsp;
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/dashboard_hemodialisa_view.php";
	...
	function GrafikLaporan() {
		var url = "pages/report/dashboard_hemodialisa_grafik.php";
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var data = {d1:d1, d2:d2};
	...
	function Excel() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/dashboard_hemodialisa_excel.php?d1=' + d1 + '&d2=' + d2;
		window.location = URL;
	}
</script>