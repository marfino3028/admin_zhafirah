<div class="row">
    <div class="col-sm-12">
        <div class="box" style="padding-bottom: 50px!important;">
            <div class="box-title">
            </div>
            <div class="box-content nopadding" style="border: 0;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<?php
							...
							if ($_POST['su'] == 'ALL' and $_POST['m'] != 'ALL') {
								$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.metode_payment='".$_POST['m']."' order by a.tgl_insert desc", 0);
							}
							elseif ($_POST['m'] == 'ALL' and $_POST['su'] != 'ALL') {
								$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.user_shift='".$_POST['su']."' order by a.tgl_insert desc", 0);
							}
							elseif ($_POST['m'] == 'ALL' and $_POST['su'] == 'ALL') {
								$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' order by a.user_shift", 0);
							}
							else {
								$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.user_shift='".$_POST['su']."' and a.metode_payment='".$_POST['m']."' order by a.tgl_insert desc", 0);
							}
						...
						<tr>
							...
							<td><?php echo $data[$i]['tgl_insert']?></td> 
						...
						<?php
							...
							if ($_POST['m'] != 'ASS' and $_POST['m'] != 'ALL') {
								$_POST['mADD'] = 'ASS';
								if ($_POST['su'] == 'ALL' and $_POST['m'] != 'ALL') {
									$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.metode_payment='".$_POST['mADD']."' order by a.tgl_insert desc", 0);
								}
								elseif ($_POST['m'] == 'ALL' and $_POST['su'] != 'ALL') {
									$data = $db->query("select a.* from tbl_kasir a where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.user_shift='".$_POST['su']."' order by a.tgl_insert desc", 0);
								}
						...
						<tr>
							...
							<td style="text-align: right;"><?php echo $data_lgs[$d]['oleh']?></td> 
						</tr> 
						<?php	
