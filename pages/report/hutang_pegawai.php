...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Hutang Karyawan</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Laporan Hutang Karyawan per Periode.
                    </h3>
                </div>
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/hutang_karyawan_view.php";
	...
	function PDFFile(ids) {
		...
		if (ids == 'NOL') { 
			...
			var URL = 'pages/report/hutang_karyawan_print.php?d1=' + d1 + '&d2=' + d2;
			popup = window.open(URL,"",windowprops);
		}
		else if (ids == 'EXC') { 
			var URL = 'pages/report/hutang_karyawan_excell.php?d1=' + d1 + '&d2=' + d2;
			popup = window.open(URL,"",windowprops);
		}
	}
</script>