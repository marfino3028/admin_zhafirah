<?php
	...
	$totalAll = $administrasi + $lab + $fis + $rad + $gigi + $pharmacy + $tindakan + $alkes;
?>
	...
	<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin"> 
		<thead> 
			...
			<?php
				...
				$totalAll = $totalAll + $umum + $obatLangsung;
			?>
			<tr style="font-weight: bold">
			...
			<?php
				...
				$total_cash = $totalAll;
				$adminAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='ADMINISTRASI' and nomor='1' and payment_to='ASURANSI'", 0);
				$pharmasiAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='PHARMACY' and payment_to='ASURANSI'", 0);
				$gigiAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='GIGI' and payment_to='ASURANSI'", 0);
				$labAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='GIGI' and payment_to='ASURANSI'", 0);
				$umumAss = $db->queryItem("select count(b.kd_poli) * c.tarif from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar left join tbl_poli c on c.kd_poli=b.kd_poli where a.no_kwitansi in (select b.no_kwitansi from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and b.kategori='ADMINISTRASI' and b.nomor='2' and b.payment_to='ASURANSI' and b.bayar > 0)", 0);
				$tindakanAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='TINDAKAN' and payment_to='ASURANSI'", 0);
				$alkesAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='alkes' and payment_to='ASURANSI'", 0);
				$fisAss = $db->queryItem("select sum(b.bayar) from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and kategori='FIS' and payment_to='ASURANSI'", 0);
				$totalAll = $totalAll + $adminAss + $pharmasiAss + $gigiAss + $labAss + $umumAss + $tindakanAss + $alkesAss + $fisAss;
				$total_ass = $adminAss + $pharmasiAss + $gigiAss + $labAss + $umumAss + $tindakanAss + $alkesAss + $fisAss;
			?>
			<tr style="font-weight: bold">
				<th colspan="2" style="text-align: left; padding-top: 25px; background-color:#FFFFFF; font-size: 14px">PENDAPATAN ASURANSI</th>
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">BIAYA ADMINISTRASI</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($adminAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">LABORATORIUM</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($labAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">FISIOTHERAPI</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($fisAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">POLI UMUM</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($umumAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">POLI GIGI</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($gigiAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">BIAYA PHARMACY</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($pharmasiAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">TINDAKAN MEDIS</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($tindakanAss)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px">ALKES</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($alkesAss)?></th> 
			</tr> 
			<?php
				$dokterAss = $db->query("select sum(b.bayar) as jumlah, b.nama, b.no_kwitansi, count(b.no_kwitansi) as jml from tbl_kasir a left join tbl_kasir_detail b on b.no_kwitansi=a.no_kwitansi where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and b.kategori='ADMINISTRASI' and b.nomor='2' and b.payment_to='ASURANSI' and b.bayar > 0 group by b.nama", 0);
				for ($i = 0; $i < count($dokter); $i++) {
					$kd_poli = $db->queryItem("select b.kd_poli from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar where a.no_kwitansi='".$dokterAss[$i]['no_kwitansi']."'");
					$nilai_poli = $db->queryItem("select tarif from tbl_poli where kd_poli='".$kd_poli."'");
					$nilai_poli = $nilai_poli * $dokterAss[$i]['jml'];
					$dokterAss[$i]['jumlah'] = $dokterAss[$i]['jumlah'] - $nilai_poli;
			?>
			<tr style="font-weight: bold">
				<th style="text-align: left; padding-left: 40px; font-size: 12px"><?php echo $dokterAss[$i]['nama']?> (DOKTER)</th>
				<th style="text-align: right; width: 150px; font-size: 14px"><?php echo number_format($dokterAss[$i]['jumlah'])?></th> 
			</tr> 
			<?php
					$totalAll = $totalAll + $dokterAss[$i]['jumlah'];
					$total_ass = $total_ass + $dokterAss[$i]['jumlah'];
				}
			?>
			<tr style="font-weight: bold">
				<th style="text-align: left; font-size: 16px">TOTAL PENDAPATAN CASH</th>
				<th style="text-align: right; width: 150px; font-size: 16px"><?php echo number_format($total_cash)?></th> 
			</tr> 
			<tr style="font-weight: bold">
				<th style="text-align: left; font-size: 16px">TOTAL PENDAPATAN ASURANSI</th>
				<th style="text-align: right; width: 150px; font-size: 16px"><?php echo number_format($total_ass)?></th> 
			</tr> 
			<tr style="font-weight: bold">
