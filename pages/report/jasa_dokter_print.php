                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<?php
							...
							if ($date1 == $date2) {
								$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and b.kode_dokter='".$_POST['dokter']."' order by a.tgl_insert desc", 0);
							}
							else {
						...
						<?php
							...
							if ($date1 == $date2) {
								$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran_jamsostek b on concat('JAM-', b.no_daftar)=a.no_daftar where a.tgl_insert >= '$date1' and b.kode_dokter='".$_POST['dokter']."' order by a.tgl_insert desc", 0);
							}
							else {
								$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran_jamsostek b on concat('JAM-', b.no_daftar)=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert <= '$date2' and b.kode_dokter='".$_POST['dokter']."' order by tgl_insert desc", 0);
							}
							$dokter = $db->query("select * from tbl_dokter where kode_dokter='".$_POST['dokter']."'");
							for ($i = 0; $i < count($data); $i++) {
