<div>
    <div class="breadcrumbs">
        <ul>
            <li>
                <a href="javascript:void(0)">Report KSO</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="javascript:void(0)">KSO Layanan Hemodialisa</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Report KSO Layanan Hemodialisa
                    </h3>
                </div>
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/kso_view.php";
	...
	function Excel() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/kso_excel.php?d1=' + d1 + '&d2=' + d2;
		window.location = URL;
	}
</script>