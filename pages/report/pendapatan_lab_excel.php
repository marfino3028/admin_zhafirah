<?php
	...
	header("Content-Disposition: attachment; filename=PendapatanLab.xls");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Print Pendapatan Lab</title>
</head>
...
?>
	...
	<p style="margin-left: 12px; margin-top: 2px; margin-bottom: 5px;">
		Laporan Pendapatan Laboratorium<br />
		Periode : <?php echo $_GET['d1'].' s/d '.$_GET['d2']?><br />
		Metode Pembayaran : <?php echo $_GET['metode']?><br />
	</p>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<?php
							...
							if ($_GET['metode'] == 'ALL') {
								$data = $db->query("select a.*, b.metode_payment as metode_pembayaran, b.kode_perusahaan as kodeNya from tbl_lab a left join tbl_kasir b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.status_delete='UD'", 0);
							}
							elseif ($_GET['metode'] == 'CASH') {
								$data = $db->query("select a.*, b.metode_payment as metode_pembayaran , b.kode_perusahaan as kodeNya from tbl_lab a left join tbl_kasir b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.status_delete='UD' and b.metode_payment='CASH'", 0);
							}
							elseif ($_GET['metode'] == 'ASS') {
								$data = $db->query("select a.*, b.metode_payment as metode_pembayaran, b.kode_perusahaan as kodeNya from tbl_lab a left join tbl_kasir b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and a.status_delete='UD' and b.metode_payment='ASS'", 0);
							}
						...
						<tr>
							...
							<td style="text-align: right;"><?php echo $sub[$j]['tarif_qty']?></td> 
						</tr> 
						<?php
								}
