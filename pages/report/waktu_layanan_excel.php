<?php
	...
	header("Content-Disposition: attachment; filename=Waktu_layanan".md5(date("YmdHis")).".xls");
    ...
    <div class="row">
        <div class="col-sm-12">
             <div class="box box-color box-bordered box-small" style="padding-bottom: 50px!important;">
                <div class="box-title">
			Rekap Waktu Layanan Pasien<br>
			Periode <?php echo date("d F Y", strtotime($date1)).' s/d '.date("d F Y", strtotime($date2))?>
                </div>
