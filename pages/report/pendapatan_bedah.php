...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
	<div class="page-title ui-widget-content ui-corner-all">
		<h1>Laporan:<b> Pendapatan Poli Bedah</b></h1>
		<div class="other">
			<div class="float-left">Laporan Pendapatan Poli Bedah per Periode.</div>
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/pendapatan_bedah_view.php";
	...
	function PDFFile(ids) {
		...
		if (ids == 'NOL') { 
			...
			var URL = 'pdf/pages/pendapatan_bedah_PDF.php?d1=' + d1 + '&d2=' + d2;
