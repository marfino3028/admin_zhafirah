...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Pendapatan Fisioterapi</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Laporan Pendapatan Fisioterapi per Periode.
                    </h3>
                </div>
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/pendapatan_fis_view.php";
	...
	function PDFFile(ids) {
		...
		if (ids == 'NOL') { 
			...
			//var URL = 'pdf/pages/pendapatan_fis_PDF.php?d1=' + d1 + '&d2=' + d2;
			var URL = 'pages/report/pendapatan_fis_print.php?d1=' + d1 + '&d2=' + d2 + '&metode=' + metode;
			popup = window.open(URL,"",windowprops);
		}
		else if (ids == 'EXC') { 
			var URL = 'pages/report/pendapatan_fis_excel.php?d1=' + d1 + '&d2=' + d2 + '&metode=' + metode;
			popup = window.open(URL,"",windowprops);
		}
		else if (ids == 'GRAF') { 
			var URL = 'pages/report/pendapatan_fis_grafik.php?d1=' + d1 + '&d2=' + d2 + '&metode=' + metode;
			popup = window.open(URL,"",windowprops);
		}
	}
</script>