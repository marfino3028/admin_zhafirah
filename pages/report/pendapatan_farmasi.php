...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Pendapatan Farmasi</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Laporan Pendapatan Farmasi per Periode.
                    </h3>
                </div>
			 ...
			 &nbsp; &nbsp;<input type="button" class="btn btn-darkblue rounded" value=" Detail!! "  onclick="TampilLaporanDetail()"  />
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/pendapatan_farmasi_view.php";
	...
	function TampilLaporanDetail() {
		var url = "pages/report/pendapatan_farmasi_view_detail.php";
		var d1 = document.getElementById('mulai').value;
		var d2 = document.getElementById('selesai').value
		var data = {d1:d1, d2:d2};
	...
	function PDFFile(ids) {
		...
		if (ids == 'NOL') { 
			...
			var URL = 'pages/report/pendapatan_farmasi_print.php?d1=' + d1 + '&d2=' + d2;
			popup = window.open(URL,"",windowprops);
		}
		else if (ids == 'EXC') { 
			var URL = 'pages/report/pendapatan_farmasi_excell.php?d1=' + d1 + '&d2=' + d2;
			//popup = window.open(URL,"",windowprops);
			window.location.href = URL;
		}
		else if (ids == 'GRAF') { 
			var URL = 'pages/report/pendapatan_farmasi_grafik.php?d1=' + d1 + '&d2=' + d2;
			popup = window.open(URL,"",windowprops);
		}
	}
</script>