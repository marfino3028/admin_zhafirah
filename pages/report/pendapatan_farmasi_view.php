                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<tr>
							...
							<td><?php echo date("d-M-Y", strtotime($data[$i]['tgl_input']))?></td> 
						...
						<tr>
							<td><?php echo $no?></td> 
							<td colspan="4"><?php echo $dl[$ii]['no_penjualan']?></td>
						...
						<tr>
							<td><?php echo $no?></td> 
							<td><?php echo $pkyn[$i]['nomr']?></td>
							<td colspan="3"><?php echo $pkyn[$i]['no_polkar']?></td>
							<td><?php echo $pkyn[$i]['nama']?></td>
