<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Laporan Waktu Layanan</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-content">
                    <div style="text-align: left; margin-left: 10px; margin-top: 0px; margin-bottom: 10px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="submit" class="btn btn-darkblue rounded" value=" Print/Cetak!! "  onclick="Cetak()"  />
                        &nbsp;&nbsp;&nbsp;&nbsp;
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/waktu_layanan_view.php";
	...
	function Cetak() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/waktu_layanan_print.php?d1=' + d1 + '&d2=' + d2;
		//window.location = URL;
	...
	function Excel() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/waktu_layanan_excel.php?d1=' + d1 + '&d2=' + d2;
		window.location = URL;
	}
</script>