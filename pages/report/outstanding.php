<div>
    <div class="breadcrumbs">
        <ul>
            <li>
                <a href="javascript:void(0)">Report Kasi</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="javascript:void(0)">List Outstanding Bill</a>
            </li>
        </ul>
    </div>
    <div class="row">
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/outstanding_view.php";
	...
	function Excel() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/outstanding_excel.php?d1=' + d1 + '&d2=' + d2;
		window.location = URL;
	}
</script>