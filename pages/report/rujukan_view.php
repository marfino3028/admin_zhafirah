                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<?php
							...
							$data = $db->query("select a.*, b.nama_dokter from tbl_pendaftaran a left join tbl_dokter b on b.kode_dokter=a.kode_dokter where a.tgl_daftar >= '$date1' and a.tgl_daftar < '$date2' and rujukan_kode != '' order by a.no_daftar", 0);
