...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Pendapatan Jamsostek</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Laporan Pendapatan Jamsostek per Periode.
                    </h3>
                </div>
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/pendapatan_jamsostek_view.php";
	...
	function PDFFile(ids) {
		...
		if (ids == 'NOL') { 
			...
			var URL = 'pdf/pages/pendapatan_jamsostek_PDF.php?d1=' + d1 + '&d2=' + d2;
