<?php
	...
	header("Content-Disposition: attachment; filename=LaporanJasaDokter.xls");
?>
...
<?php
	...
	$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert < '$date2' and b.kode_dokter='".$_GET['dokter']."' order by tgl_insert desc", 0);
...
<body>
	...
	<p style="margin-left: 12px; margin-top: 2px; margin-bottom: 5px;">
		...
		Dokter : <?php echo $dokter[0]['nama_dokter']?><br />
	</p>
