<?php
	...
	header("Content-Disposition: attachment; filename=Hemodialisa.xls");
?>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<tr>
							...
							<td style="text-align: right;"><?php echo $data[$i]['perawat']?></td> 
							<td style="text-align: right;"><?php echo $data[$i]['hemo']?></td> 
						</tr> 
						<?php
