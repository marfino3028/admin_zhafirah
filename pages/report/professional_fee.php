<div>
    <div class="breadcrumbs">
        <ul>
            <li>
                <a href="javascript:void(0)">Laporan Professional Fee</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="javascript:void(0)">Professional Fee</a>
            </li>
        </ul>
    </div>
    <div class="row">
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/report/professional_fee_view.php";
	...
	function Excel() {
		...
		var d1 = document.getElementById('tgl_mulai').value;
		var d2 = document.getElementById('tgl_selesai').value
		var URL = 'pages/report/professional_fee_excel.php?d1=' + d1 + '&d2=' + d2;
		window.location = URL;
	}
</script>