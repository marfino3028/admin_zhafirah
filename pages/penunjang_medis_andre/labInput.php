...
<div class="page-title ui-widget-content ui-corner-all">
					<h1>Data Transaksi: Laboratorium </h1>
					<div class="other">
						<div class="float-left">Insert, Update, Delete Data Pemeriksaan Laboratorium.</div>
					...
					<form method="post" action="index.php?mod=penunjang_medis&submod=labInput">
                        ...
                        <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
									...
									?>
                                    <a class="btn_no_text btn" style="border-radius: 4px;" title="Edit" href="index.php?mod=penunjang_medis&submod=input_lab_tindakan&id=<?php echo $data[$i]['id']?>">
                                        <span class="ui-icon ui-icon-wrench"></span>
                                    </a>
                                    <a class="btn_no_text btn" style="border-radius: 4px;" title="Delete" href="#" onclick="return window.location = 'pages/penunjang_medis/lab_delete.php?id=<?php echo $data[$i]['id']?>';">
