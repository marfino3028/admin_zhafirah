<?php
	...
	$ceknmr = $db->queryItem("select max(right(no_rad, 3)*1) from tbl_rad where left(right(no_rad, 11), 8)='".date("dmY")."'", 0);
	$ceknmr = $ceknmr + 1;
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Transaksi Radiologi </div>
	<form action="javascript:simpanData(this.form, 'pages/penunjang_medis/input_rad_insert.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
    <div align="left">
           ...
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="240" bordercolor="#000000">
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">No. Radiologi</span></td>
                        ...
                        <tr height="28">
                            ...
                            <div style="margin-bottom: 14px; margin-top: 14px; margin-left: 15px;">
                             <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Radiologi" onclick="simpanData(this.form, 'pages/penunjang_medis/input_rad_insert.php')" />
                            </div></td>
                        </tr>
                    </table>
                </div>
