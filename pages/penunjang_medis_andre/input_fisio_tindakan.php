...
<script language="javascript">
	...
	function simpanTindakanFis() {
		...
		var data = {id:id, no_fisio:no_fisio, nomr:nomr, nama:nama, fis:fis, tarif:tarif};
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Detail Tindakan Fisioterapi </div>
           ...
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px; margin-bottom: 10px; margin-left: 5px; background-color: #E6E6E6;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse; margin-top: 10px; margin-bottom: 5px;" width="310" bordercolor="#000000">
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px; margin-top: 5px;">No. Fisioterapi </span></td>
                        ...
                        <tr height="28">
                            ...
                            <select id="fis" name="fis" size="1" style="width: 190px;" tabindex="1" onchange="TampilHarga(this.value)" >
								<option value="">--Pilih Tindakan Fisioterapi--</option>
								<?php
									$lab = $db->query("select * from tbl_tarif where kode_jns_tarif='5' and status_delete='UD' order by kode_kat_pelayanan");
									...
									<table border="0" cellpadding="0" style="border-collapse: collapse;">
										...
										<tr height="28">
											...
											<div style="margin-bottom: 14px; margin-top: 14px; margin-left: 15px;" align="center">
											 <input type="button" value="Simpan Tindakan" onclick="simpanTindakanFis()" />
