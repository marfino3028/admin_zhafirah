...
<div class="page-title ui-widget-content ui-corner-all">
					<h1>Data Transaksi: Fisiotherapi </h1>
					<div class="other">
						<div class="float-left">Insert, Update, Delete Data Pemeriksaan Fisiotherapi.</div>
					...
					<form method="post" action="index.php?mod=penunjang_medis&submod=fisiotherapiInput">
	...
	<form action="javascript:simpanData(this.form, 'pages/penunjang_medis/radiologiInput_insert.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
        <div class="row">
        <div class="col-sm-12">
