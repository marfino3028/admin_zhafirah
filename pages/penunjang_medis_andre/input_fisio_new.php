...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Transaksi Fisiotherapi </div>
           ...
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="240" bordercolor="#000000">
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px " style="width:10">No. Fisiotherapi</span></td>
