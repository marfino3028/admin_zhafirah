...
<div class="page-title ui-widget-content ui-corner-all">
					<h1>Data Transaksi: Radiologi </h1>
					<div class="other">
						<div class="float-left">Insert, Update, Delete Data Pemeriksaan Radiologi.</div>
					...
					<form method="post" action="index.php?mod=penunjang_medis&submod=radiologiInput">
