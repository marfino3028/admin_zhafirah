            ...
            <div class="box">
              <div class="box-title">
                <h3>
                  ...
                  Scan Konfirmasi Pengambilan Hasil Lab
                </h3>
              </div>
              <div class="box-content">
        <form action="pages/qrcode/lab_insert.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered form-column" name="form_karyawan" id="form_karyawan" >
            <div class="row">
              ...
              <div class="box-content nopadding" style="overflow-x:auto; min-height: 350px;">
                ...
                <table id="table-data" class="table table-hover table-responsive table-nomargin table-bordered" style="padding-top: 0px;">
                  ...
                  <tbody>
                    <?php
                        $today = date("Y-m-d");
			$data = $db->query("select * from tbl_kiosk_lab order by id desc", 0);
