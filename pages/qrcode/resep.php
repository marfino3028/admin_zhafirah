            ...
            <div class="box">
              <div class="box-title">
                <h3>
                  ...
                  Scan Konfirmasi Resep & Obat
                </h3>
              </div>
              <div class="box-content">
        <form action="pages/qrcode/resep_insert.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered form-column" name="form_karyawan" id="form_karyawan" >
            <div class="row">
                ...
                <table id="table-data" class="table table-hover table-responsive table-nomargin table-bordered" style="padding-top: 0px;">
                  <thead>
                    <tr>
                      ...
                      <th>Waktu Konfirmasi Resep</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        $today = date("Y-m-d");
			$data = $db->query("select * from tbl_kiosk_resep order by id desc", 0);
