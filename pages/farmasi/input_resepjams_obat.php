<?php
	$data = $db->query("select * from tbl_resepjams where id='".$_GET['id']."'");
	$dataTdk = $db->query("select no_daftar, nomr from tbl_resepjams where id='".$_GET['id']."'", 0);
?>
<script language="javascript">
	...
	function simpanObat() {
		...
		var url = "pages/farmasi/input_resepJams_obat_detail.php";
	...
	function CreateRacikan(id) {
		if (id == 'RACIK') {
			...
			var url = "pages/farmasi/input_resepJam_obat_qty.php";
			var data = {id:id};
	...
	function TambahRacikan() {
		...
		var url = "pages/farmasi/input_resepJams_obat_detail_racik_insert.php";
	...
	function simpanObatRacikan() {
		...
		var url = "pages/farmasi/input_resepJams_obat_detail_racik_obat_insert.php";
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Detail Resep Pasien Jamsostek</div>
                    ...
                    <table border="1" cellpadding="0" style="border-collapse: collapse; margin-top: 10px; margin-bottom: 5px;" width="310" bordercolor="#000000">
                        ...
                        <tr height="28">
                            ...
                            <select id="obat" name="obat" size="1" style="width: 190px;" tabindex="1" onchange="CreateRacikan(this.value)">
								...
								<!--<option value="MEDIS">Tindakan Medis</option>-->
								<option value="RACIK">Obat Racikan</option>
                ...
                <td>
                    <div id="data_pasien">
                        ...
                        <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin"> 
                            ...
                            <tbody> 
                            <?php
                                $data = $db->query("select * from tbl_resepjams_detail where status_delete='UD' and resep_id='".$_GET['id']."'", 0);
						...
						&nbsp;
						<?php
							$resep = $db->query("select * from tbl_racikanjams where no_resep='".$data[0]['no_resep']."' and status_delete='UD'", 0);
