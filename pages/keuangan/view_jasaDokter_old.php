                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered"> 
						...
						<?php
							...
							if ($date1 == $date2) {
								$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar where date(a.tgl_insert) = '$date1' and b.kode_dokter='".$_POST['dokter']."' and a.status_bayar_dokter='BLM' order by a.tgl_insert desc", 0);
							}
							else {
								$data = $db->query("select a.*, b.biayaAdmin, b.kode_dokter, b.kd_poli from tbl_kasir a left join tbl_pendaftaran b on b.no_daftar=a.no_daftar where a.tgl_insert >= '$date1' and a.tgl_insert <= '$date2' and b.kode_dokter='".$_POST['dokter']."' and a.status_bayar_dokter='BLM' order by tgl_insert desc", 0);
							}
