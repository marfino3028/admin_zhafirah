<?php
	...
	$data = $db->query("select * from tbl_rawat where id='".$_GET['id']."'");
?>
<script language="javascript">
	...
	function simpanTindakanLab() {
		...
		var url = "pages/ranap/simpanRawatTindakan.php";
...
<script language="javascript">
	$(document).ready(function() {
		$("#lab").select2({
		    ...
		    ajax: {
				url : "pages/functions/keperawatan.php",
		        dataType: 'json',
		        type: "GET",
		        quietMillis: 50,
		        data: function (term) {
...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Keperawatan</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box box-color box-bordered box-small blue">
                                <div class="box-title">
                                    <h3>
                                        <i class="fa fa-edit"></i> Form Tindakan Keperawatan
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="textfield" class="control-label col-sm-4">No. Rawat </label>
                                                    <div class="col-sm-8">
                                                        <?php echo $data[0]['no_rawat']?>
                                                        <input type="hidden" id="no_lab" name="no_lab" value="<?php echo $data[0]['no_rawat']?>" />
                                                ...
                                                <div id="DataAdd">
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="List Pasien Rawat Inap" onclick="simpanData(this.form, 'index.php?mod=ranap&submod=ranap')" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                    <div id="data_pasien">	
                                                      	<p style="margin-top: 15px; margin-left: 15px; font-size: 18px;">Daftar Tindakan Keperawatan</p>
                                                        <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                            $data = $db->query("select * from tbl_rawat_detail where status_delete='UD' and no_rawat='".$data[0]['no_rawat']."'", 0);
                                                            for ($i = 0; $i < count($data); $i++) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><a class="btn_no_text btn" style="border-radius: 4px;" title="Delete" href="#" onclick="return window.location = 'pages/ranap/rawat_delete.php?id=<?php echo $data[$i]['id'].'&subid='.$_GET['id']?>';"> <span class="ui-icon ui-icon-circle-close"></span> </a> </td>
                                                                </tr>
                                                                <?php
