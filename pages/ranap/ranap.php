<div>
    <div class="breadcrumbs">
        <ul>
            <li>
                <a href="javascript:void(0)">Rawat Inap</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="javascript:void(0)">Pasien Rawat Inap</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-title">
					...
					?>
                    <form action="index.php?mod=ranap&submod=ranap" method="POST" class='form-horizontal form-bordered'>
                            ...
                            <div class="box box-color box-bordered box-small" style="padding-bottom: 50px!important; min-height: 300px;">
                                <div class="box-title">
                                    <h3 style="padding-right: 50px;">
                                        <i class="fa fa-table"></i> Worklist Dokter Rawat Inap
                                    </h3>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="index.php?mod=ranap&submod=worklist&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">Input/Edit Pemeriksaan</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="pages/ranap/keperawatan.php?id=<?php echo md5($data[$i]['resep'])?>">Input Tindakan Keperawatan</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                  	<?php
