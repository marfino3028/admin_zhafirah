                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="280" bordercolor="#000000">
                        <tr height="28">
                            ...
                            <input type="text" id="no_kwitansi" name="no_kwitansi" class="form-control" style="width: 100px; background-color:#CCC; width: 120px;" value="<?php echo $data[0]['no_kwitansi']?>" readonly="readonly" />
                            </div></td>
                        </tr>
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">NO. FR</span></td>
                            <td valign="middle" align="center">
                            	<input type="text" id="nofr" name="nofr" value="<?php echo $data[0]['nofr']?>" class="form-control" style="width: 120px; text-align: left; font-weight: bold; background-color:#CCC;" readonly="readonly" />
							</td>
                        </tr>
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            	<input type="text" id="nodaftar" name="nodaftar" value="<?php echo $data[0]['no_daftar']?>" class="form-control" style="width: 120px; text-align: left; font-weight: bold; background-color:#CCC;" readonly="readonly" />
                            </div></td>
                        </tr>
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">Total Bayar</span></td>
                            <td valign="middle" align="center">
                            	<input type="text" id="total_bayar_text" name="total_bayar_text" value="<?php echo number_format($data[0]['total'])?>" class="form-control" readonly="" style="width: 120px; text-align: right; font-weight: bold; background-color:#CCC;" />
                            	<input type="hidden" id="total_bayar" name="total_bayar" value="<?php echo $data[0]['total']?>" style="width: 120px; text-align: right; font-weight: bold" />
							</td>
                        </tr>
                        <!--<tr height="28">
                        ...
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            	<input type="text" id="penjamin" name="penjamin" value="<?php echo $data[0]['penjamin']?>" class="form-control" style="width: 120px; font-weight: bold; background-color:#CCC;" readonly="readonly" />
                        ...
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            	<input type="text" id="diskon" name="diskon" class="form-control" value="0" style="width: 120px; text-align: right; font-weight: bold; background-color:#CCC;" readonly="readonly" />
							</td>
                        </tr>
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            	<input type="text" id="metode" name="metode" value="<?php echo $data[0]['metode_payment']?>" class="form-control" style="width: 120px; font-weight: bold; background-color:#CCC;" readonly="readonly" />
                            </div></td>
                        </tr>
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">Tgl Transaksi</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            	<input type="text" id="mulai" name="mulai" value="<?php echo date("m/d/Y", strtotime($data[0]['tgl_insert']))?>" class="form-control" style="width: 120px; font-weight: bold;" />
