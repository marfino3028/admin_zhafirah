			...
			<td valign="middle" colspan="2">
				<div class="hastable box box-content nopadding" align="left" style="margin-left: 0; margin-right: 0; width: 100%; margin-top: 0px;">
					...
					<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
						...
						<!--<tr>
							<td style="width: 15px; text-align: right">-</td> 
							<td style="text-align: left"><?php echo $adm[$i]['nama']?></td> 
							<td style="text-align: right"><?php echo number_format($adm[$i]['bayar'])?></td>
						</tr>--> 
						<?php
					...
					<table width="1054" id="sort-table" style="margin-bottom: 5px; margin-top: 7px;"> 
						...
						<!--<tr>
							<td style="width: 15px; text-align: right">-</td> 
							<td style="text-align: left"><?php echo $adm[$i]['nama']?></td> 
							<td style="text-align: right; width: 150px;"><?php echo number_format($adm[$i]['bayar'])?></td>
						</tr> -->
						<?php
					...
					<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin"> 
						...
						<tr>
							<th colspan="2" style="text-align: right; margin-right: 5px; font-size: 10px;">Diskon</th> 
