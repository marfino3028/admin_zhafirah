			...
			<form action="pages/dokter/<?php echo $menuju ?>" method="POST" class='form-horizontal form-bordered' enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="anamnesis" name="anamnesis" placeholder="Anamnesis"><?php echo trim($sub[0]['anamnesis'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Anamnesis (Doctor)</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="cc_hpi" name="cc_hpi" placeholder="CC + HPI"><?php echo trim($sub[0]['cc_hpi'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
				...
				<div class="form-group">
					<div class="col-sm-3">
						...
						<input type="text" class="form-control" id="v_weight" name="v_weight" placeholder="Berat Badan" value="<?php echo $sub[0]['v_weight'] ?>">
					</div>
					<div class="col-sm-3">
						<small>Tinggi Badan</small>
						<input type="text" class="form-control" id="v_height" name="v_height" placeholder="Tinggi Badan" value="<?php echo $sub[0]['v_height'] ?>">
					</div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						...
						<input type="text" class="form-control" id="v_bp" name="v_bp" placeholder="Vitals-BP Sistolik" value="<?php echo $sub[0]['v_bp'] ?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-3">
						<small>Nadi</small>
						<input type="text" class="form-control" id="v_pr" name="v_pr" placeholder="Nadi" value="<?php echo $sub[0]['v_pr'] ?>">
					</div>
					<div class="col-sm-3">
						<small>Frekuensi Napas</small>
						<input type="text" class="form-control" id="v_rr" name="v_rr" placeholder="Frekuensi Napas" value="<?php echo $sub[0]['v_rr'] ?>">
					</div>
					<div class="col-sm-3">
						<small>Suhu</small>
						<input type="text" class="form-control" id="v_temp" name="v_temp" placeholder="Suhu" value="<?php echo $sub[0]['v_temp'] ?>">
					</div>
					<div class="col-sm-3">
						<small>Vitals-BP Diastolik</small>
						<input type="text" class="form-control" id="v_bpd" name="v_bpd" placeholder="Vitals-BP Diastolik" value="<?php echo $sub[0]['v_bpd'] ?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<div class="col-sm-12" style="padding-top: 5px; padding-left: 5px;">
							...
							<textarea tabindex="2" cols="50" rows="3" class="form-control" id="pe_eks" name="pe_eks" placeholder="Eks"><?php echo trim($sub[0]['pe_eks'])?></textarea>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="s_exam" name="s_exam" placeholder="Systemic Examination"><?php echo trim($sub[0]['s_exam'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Laboratorium / Radiology</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="observation" name="observation" placeholder="Observation"><?php echo trim($sub[0]['observation'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="as_problems" name="as_problems" placeholder="Diagnosis"><?php echo trim($sub[0]['as_problems'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<small>Order</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="plan_order" name="plan_order" placeholder="Order"><?php echo trim($sub[0]['plan_order'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Advice</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="plan_advice" name="plan_advice" placeholder="Advice"><?php echo trim($sub[0]['plan_advice'])?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
