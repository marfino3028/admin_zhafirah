...
if ($sub[0]['id'] > 0) $menuju = "worklist_insert.php";
		...
		<div class="col-sm-7">
			<form action="pages/dokter/<?php echo $menuju ?>" method="POST" class='form-horizontal form-bordered' enctype="multipart/form-data">
				<div class="form-group">
					<div class="col-sm-5">
						<small>Tipe SOAP</small>
						<select id="tipe_soap" name="tipe_soap" class='chosen-select form-control' required="required">
							<option value="">--pilih tipe SOAP--</option>
							<option value="DOKTER">Dokter</option>
							<option value="PERAWAT">Perawat</option>
						</select>
					</div>
					<div class="col-sm-7">
						<small>Tipe Dokter</small>
						<select id="dokter_soap" name="dokter_soap" class='chosen-select form-control' required="required">
							<option value="">--pilih Dokter SOAP--</option>
							<?php
				...
				<div class="form-group">
					<div class="col-sm-5">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="verifikasi" value="YES">Centang jika SOAP membutuhkan verifikasi
							</label>
						</div>
					</div>
					<div class="col-sm-7">
						<small>Tipe Dokter</small>
						<select id="dokter_verifikasi" name="dokter_verifikasi" class='chosen-select form-control'>
							<option value="">--pilih Dokter Verifikasi SOAP--</option>
							<?php
								$dokter = $db->query("select * from tbl_dokter where status_delete='UD'");
								for ($i = 0; $i < count($dokter); $i++) {
									echo '<option value="'.$dokter[$i]['kode_dokter'].'">'.$dokter[$i]['nama_dokter'].'</option>';
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="anamnesis" name="anamnesis" placeholder="Anamnesis"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Anamnesis (Doctor)</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="cc_hpi" name="cc_hpi" placeholder="CC + HPI"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Past Medical History</small>
						<input type="text" class="form-control" id="past_med_history" name="past_med_history" placeholder="Past Medical History" onkeydown="pindahField(event)">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<small>Past Surgical History</small>
						<input type="text" class="form-control" id="past_surgical_histort" name="past_surgical_histort" placeholder="Past Surgical History" onkeydown="pindahField(event)">
					</div>
					<div class="col-sm-6">
						<small>Allergies</small>
						<input type="text" class="form-control" id="alergi" name="alergi" placeholder="Allergies" onkeydown="pindahField(event)">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Other</small>
						<input type="text" class="form-control" id="other_subject" name="other_subject" placeholder="Other" onkeydown="pindahField(event)">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<div class="col-sm-12" style="padding-top: 5px; padding-left: 5px;">
							...
							<textarea tabindex="2" cols="50" rows="3" class="form-control" id="pe_eks" name="pe_eks" placeholder="Pemeriksaan Fisik"></textarea>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="observation" name="observation" placeholder="Observation"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Other</small>
						<input type="text" class="form-control" id="other_obj" name="other_obj" placeholder="Other" onkeydown="pindahField(event)">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						...
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="as_problems" name="as_problems" placeholder="Diagnosis"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<small>Progress Note</small>
						<input type="text" class="form-control" id="as_progres" name="as_progres" placeholder="Progress Note" onkeydown="pindahField(event)">
					</div>
					<div class="col-sm-6">
						<small>Other</small>
						<input type="text" class="form-control" id="other_as" name="other_as" placeholder="Other" onkeydown="pindahField(event)">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-12">
						<small>Order</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="plan_order" name="plan_order" placeholder="Order"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<small>Advice</small>
						<textarea tabindex="2" cols="50" rows="3" class="form-control" id="plan_advice" name="plan_advice" placeholder="Advice"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<small>Konsul Internal</small>
						<input type="text" class="form-control" id="konsul_internal" name="konsul_internal" placeholder="Konsul Internal" onkeydown="pindahField(event)">
					</div>
					<div class="col-sm-6">
						<small>Order OK / VK</small>
						<input type="text" class="form-control" id="order_ok" name="order_ok" placeholder="Order OK / VK" onkeydown="pindahField(event)">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<small>Prescription</small>
						<input type="text" class="form-control" id="prescrip" name="prescrip" placeholder="Prescription" onkeydown="pindahField(event)">
					</div>
					<div class="col-sm-6">
						<small>Other</small>
						<input type="text" class="form-control" id="other_plan" name="other_plan" placeholder="Other" onkeydown="pindahField(event)">
					</div>
				</div>
