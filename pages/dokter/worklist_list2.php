    ...
    <div class="col-sm-12">
      <div class="box">
        <div class="box-title">
          ...
          <a href="index.php?mod=dokter&submod=worklist_form&id=<?php echo $_GET['id'] . '&ids=' . $_GET['ids'] ?>" class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Input Pemeriksaan</a>
        </div>
		    ...
		    echo '<small><b>CC + HPI :</b> ' . $data[$i]['cc_hpi'] . '</small><br>';
                  ...
                  <td>
                    ...
                    echo '<small><b>Vitals-Temp :</b> ' . $data[$i]['v_temp'] . '</small><br>';
                     echo '<small><b>Physical Examination-Eks :</b> ' . $data[$i]['pe_eks'] . '</small><br>';
                    echo '<small><b>Systemic Examination :</b> ' . $data[$i]['s_exam'] . '</small><br>';
