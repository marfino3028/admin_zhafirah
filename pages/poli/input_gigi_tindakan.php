...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Detail Tindakan Poli Gigi </a>
            </li>
        </ul>
    </div>
    <div class="row">
                            ...
                            <div class="box box-color box-bordered box-small blue">
                                <div class="box-title">
                                    <h3>
                                        ...
                                        Form Tambah Data Detail Tindakan Poli Gigi
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="gigi" name="gigi" onchange="TampilHarga(this.value)" style="width: 100%;" >
                                                    </div>
                                                </div>
                                                <div id="DataAdd">
                                                    <div class="form-group">
