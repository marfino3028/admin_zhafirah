<?php
	...
	$ceknmr = $db->queryItem("select max(right(no_umum, 3)*1) from tbl_umum where left(right(no_umum, 11), 8)='".date("dmY")."'", 0);
	$ceknmr = $ceknmr + 1;
                            ...
                            <div class="box box-color box-bordered box-small blue">
                                <div class="box-title">
                                    <h3>
                                        ...
                                        Form Tambah Data Transaksi Poli Umum
                                </div>
                                <div class="box-content nopadding">
                                    <form action="javascript:simpanData(this.form, 'pages/pendaftaran/daftar_insert.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="textfield" class="control-label col-sm-4">No. Gigi</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select id="nodaftar" name="nodaftar" size="1" onchange="CariPasien(this.value)" class="form-control">
                                        ...
                                        <div class="form-actions">
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Poli Umum" onclick="simpanData(this.form, 'pages/poli/umum_insert.php')" />
                                        </div>
                                    </form>
                                </div>
                            </div>
