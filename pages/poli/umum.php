<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Pasien Poli Umum</a>
            </li>
        </ul>
    </div>
    <div class="row">
                            ...
                            <div class="box box-color box-bordered box-small" style="padding-bottom: 70px!important; min-height: 390px;">
                                <div class="box-title">
                                    <h3 style="padding-right: 90px;">
                                        <i class="fa fa-table"></i> Worklist Dokter Layanan Poli Umum
                                    </h3>
                                ...
                                <div class="box-content nopadding" style="min-height: 390px;">
                                    ...
                                    <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered" style="padding-top: 15px;">
                                        ...
                                        <?php
                                        if ($_POST['metode'] == "" or $_POST['metode'] == "ALL") {
                                            $data = $db->query("select a.no_daftar, a.status_mesin, b.tipe_mesin, a.nomr, a.tgl_daftar, a.kode_dokter, a.id, a.status_pasien, a.nama_perusahaan, a.biayaAdmin, a.kd_poli, a.yang_berobat from tbl_pendaftaran a left join tbl_catatan_dktr_hd b on b.no_daftar=a.no_daftar where a.status_delete='UD' and kd_poli='P001' and kd_poli!='SKS' and a.tgl_daftar >= '".$_POST['d1']."' and a.tgl_daftar <= '".$_POST['d2']."' and a.no_daftar <> '' order by a.id desc", 0);
                                        }
                                        else {
                                            $data = $db->query("select a.no_daftar, a.status_mesin, b.tipe_mesin, a.nomr, a.tgl_daftar, a.kode_dokter, a.id, a.status_pasien, a.nama_perusahaan, a.biayaAdmin, a.kd_poli, a.yang_berobat from tbl_pendaftaran a left join tbl_catatan_dktr_hd b on b.no_daftar=a.no_daftar where a.status_delete='UD' and kd_poli='P001' and kd_poli!='SKS' and a.status_pasien='".$_POST['metode']."' and a.tgl_daftar >= '".$_POST['d1']."' and a.tgl_daftar <= '".$_POST['d2']."' and a.no_daftar <> '' order by a.id desc", 0);
                                        }
							...
							<a href="index.php?mod=hd&submod=worklist_view&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>" style="font-size: 12px;">Catatan<br>Hemodialisa</a>
                                                    ...
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a href="pages/hd/keperawatan_poli.php?id=<?php echo md5($data[$i]['resep'])?>">Input Tindakan Medis</a></li>
