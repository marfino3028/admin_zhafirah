        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-title">
                    ...
                    <a href="index.php?mod=penunjang_medis&submod=fisio_soap_form_worklist&id=<?php echo $_GET['id'] . '&ids=' . $_GET['ids']; ?>&fisio=<?= $_GET['fisio']; ?>" class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Input Pemeriksaan</a>
                </div>
            ...
            <div class="box">
                ...
                <div class="box-content nopadding" style="overflow-x:auto; min-height: 350px;">
                    ...
                    <table id="table-data" class="table table-hover table-responsive table-nomargin table-bordered" style="padding-top: 0px;">
                        ...
                        <tbody>
                            <?php
                            $data = $db->query("select * from tbl_fisio where nomr='".$_GET['id']."' and no_daftar='".$_GET['ids']."' order by tgl_input_fisio desc");
