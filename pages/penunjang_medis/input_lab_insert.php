<?php
	...
	if ($_SESSION['rg_user'] != '') {
		...
		if ($_POST['idmr'] == "") {
			...
			$insert = $db->query("insert into  tbl_lab (no_lab, nomr, nama, tgl_input_lab, total_harga_lab, no_daftar) values ('".$_POST['no_resep']."', '".$_POST['nomr']."', '".$nama."', '".date("Y-m-d")."', '0', '".$_POST['nodaftar']."')", 0);
			$id = mysql_insert_id();
