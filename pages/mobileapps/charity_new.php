                        ...
                        <div class="col-sm-12">
                            <div class="box box-color box-bordered box-small blue">
                                ...
                                <div class="box-content nopadding">
                                    <form action="javascript:simpanData(this.form, 'pages/mobileapps/charity_insert.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered  form-validate form-validate" name="form_karyawan" id="form_karyawan" >
                                        ...
                                        <div class="form-actions">
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Charity dan Donasi" onclick="simpanData(this.form, 'pages/mobileapps/charity_insert.php')" />
                                        </div>
                                    </form>
                                </div>
                            </div>
