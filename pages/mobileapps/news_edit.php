                                ...
                                <div class="box-content nopadding">
                                    <form action="javascript:simpanData(this.form, 'pages/master/perusahaan_update.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Update Promo dan Berita" onclick="simpanData(this.form, 'pages/mobileapps/news_update.php')" />
                                        </div>
                                    </form>
                                </div>
                            </div>
