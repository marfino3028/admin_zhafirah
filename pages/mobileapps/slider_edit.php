	<?php
	$data = $db->query("select * from tbl_image where id='".$_GET['id']."'");
                        ...
                        <div class="col-sm-12">
                            <div class="box box-color box-bordered box-small blue">
                                ...
                                <div class="box-content nopadding">
                                    <form action="javascript:simpanData(this.form, 'pages/mobileapps/slider_update.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered  form-validate form-validate" name="form_karyawan" id="form_karyawan" >
                        				...
                        				<div class="form-group">
                        					...
                        					<label for="textfield" class="control-label col-sm-10">
                        						<?php
                            			            $sub = $db->query("select * from tbl_image where id='".$dt[0]['id']."'");
                            			            echo '<img src="../../dokumen/'.$data[0]['dokumen_im'].'" width="200" style="">';
                            			        ?>
                        					</label>
                        				</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Update Image Slider" onclick="simpanData(this.form, 'pages/mobileapps/slider_update.php')" />
                                        </div>
                                    </form>
                                </div>
                            </div>
