            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Purchase Order dari pusat ke vendor/supplier.
                    </h3>
                </div>
                <div class="box-content">
					...
					Daftar Purchase Order dari pusat ke Vendor/Supplier
                                    </h3>
                                ...
                                <div class="box-content nopadding" style="overflow-x:auto;">
                                    ...
                                    <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
                                        ...
                                        if ($_POST['search'] == "")
                                            $data = $db->query("select b.*, a.no_po, a.total_po, a.nama_vendor, a.nama_suplier, a.id kodeid from  tbl_po a left join tbl_ro b on b.no_ro=a.no_ro where a.input_by='".$_SESSION['rg_user']."' order by a.tgl_input_po desc", 0);
                                        else
                                            $data = $db->query("select b.*, a.no_po, a.total_po, a.nama_vendor, a.nama_suplier, a.id kodeid from  tbl_po a left join tbl_ro b on b.no_ro=a.no_ro where a.input_by='".$_SESSION['rg_user']."' and a.no_po like '%".$_POST['search']."%' order by a.tgl_input_po desc", 0);
                                        for ($i = 0; $i < count($data); $i++) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn_no_text btn" style="border-radius: 4px;" title="Delete" href="#" onclick="return window.location = 'pages/inv/po_delete.php?id=<?php echo $data[$i]['kodeid']?>';">
