...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Data Detail PO</a>
            </li>
        </ul>
    </div>
    <div class="row">
                                    ...
                                    <form action="pages/inv/po_update.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" name="form_karyawan" id="form_karyawan" >
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="textfield" class="control-label col-sm-4">Tgl  Input PO</label>
                                                    <div class="col-sm-8">
                                                        <?php echo date("d F Y", strtotime($po[0]['tgl_input_po']))?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                    <div id="data_pasien">
                                                        ...
                                                        <div class="form-actions">
                                                            ...
                                                            <input type="submit" value="Simpan Detail PO" class="btn btn-sm btn-small btn-primary rounded" />
