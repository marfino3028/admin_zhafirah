...
<div align="left" style="margin-left: 3%;">
    ...
    <div>
        <table id="table-data" class="table table-hover table-nomargin table-bordered nomargin">
            <thead>
            <tr>
            ...
            for ($i = 0; $i < count($adm); $i++) {
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        <input type="text" id="qty[<?php echo $i?>]" name="qty[<?php echo $i?>]" class="form-control text-right" value="<?php echo number_format($adm[$i]['qty'])?>"/>
                        <input type="hidden" id="id[<?php echo $i?>]" name="id[<?php echo $i?>]" value="<?php echo $adm[$i]['id']?>" />
                    </td>
                    <td style="text-align: right">
                        <input type="text" id="harga[<?php echo $i?>]" name="harga[<?php echo $i?>]" class="form-control text-right" value="<?php echo number_format($adm[$i]['harga'])?>"/>
                    </td>
