<?php
	...
	$data = $db->query("select * from tbl_opname_apotik where id='".$_GET['id']."'");
?>
...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Detail Stock Opname Apotik</a>
            </li>
        </ul>
    </div>
    <div class="row">
                            ...
                            <div class="box box-color box-bordered box-small blue">
                                <div class="box-title">
                                    <h3>
                                        ...
                                        Form Tambah Data Detail Stock Opname Apotik
                                </div>
                                <div class="box-content nopadding">
                                    <form action="javascript:simpanData(this.form, 'pages/pendaftaran/daftar_insert.php')" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered form-column" name="form_karyawan" id="form_karyawan" >
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo $data[0]['no_opn_apotik']?>
                                                        <input type="hidden" id="no_opn_apotik" name="no_opn_apotik" value="<?php echo $data[0]['no_opn_apotik']?>" />
                                                        <input type="hidden" id="opn_apotikID" name="opn_apotikID" value="<?php echo $data[0]['id']?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="textfield" class="control-label col-sm-4">Tanggal Input</label>
                                                    <div class="col-sm-8">
                                                        <?php echo date("d-m-Y", strtotime($data[0]['tgl_input_opn_apotik']))?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="data_pasien">
                                                    <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                        $data = $db->query("select * from tbl_opname_apotik_detail where status_delete='UD' and opn_apotikID='".$data[0]['id']."'", 0);
                                        ...
                                        <div class="form-actions">
                                            <input type="button" value="Simpan Detail Opname" class="btn btn-sm btn-small btn-primary rounded" onclick="simpanData(this.form, 'pages/inv/simpan_ApotikApotik_detail.php')" />
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="List Opname" onclick="simpanData(this.form, 'index.php?mod=inv&submod=stock_opnameA')" />
                                        </div>
                                    </form>
                                </div>
                            </div>
