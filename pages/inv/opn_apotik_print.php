...
<?php
	...
	$ro = $db->query("select * from tbl_opname_apotik where md5(no_opn_apotik)='".$_GET['id']."'", 0);
...
<div align="left">
	...
	<div>
        <p style="text-align: center; font-size: 14px; font-weight: bold; margin-bottom: 2px;">
            <h1 style="text-align: center;">STOCK OPNAME APOTIK</h1>
            <h5 style="text-align: center;">NO.STOCK OPNAME : <?php echo $ro[0]['no_opn_apotik']?></h5>
        </p>
    ...
    <div>
        <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
            ...
            <?php
            $totgigi = 0;
            $adm = $db->query("select * from tbl_opname_apotik_detail where md5(no_opn_apotik)='".$_GET['id']."' and status_delete='UD'");
