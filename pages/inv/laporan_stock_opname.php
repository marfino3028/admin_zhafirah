...
<div>
    <div class="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="javascript:void(0)">Stock Opname</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="box">
                <div class="box-title">
                    <h3>
                        ...
                        Laporan Stock Opname Per Bulan Per Unit
                    </h3>
                </div>
                <div class="box-content">
                    <div style="text-align: left; margin-left: 10px; margin-top: 0px; margin-bottom: 10px;">
                        Unit/Periode Bulan &nbsp; &nbsp;
                        <select id="unit" name="unit" size="1" style="width: 100px;">
...
<script language="javascript">
	function TampilLaporan() {
		var url = "pages/inv/laporan_stock_opname_view.php";
		var bulan = document.getElementById('bulan').value;
		var tahun = document.getElementById('tahun').value
		var unitS = document.getElementById('unit').value
		var data = {bulan:bulan, tahun:tahun, units: unitS};
