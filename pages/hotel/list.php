<?php
$data=$db->query("SELECT*FROM tbl_hotel ORDER BY nama_hotel ASC");
?>
<style>
...
<a href="?mod=hotel&submod=add" class="btn-add">➕ Tambah Data Hotel</a>
...
<td><?=$r['kode_hotel']?></td>
<td><?=$r['nama_hotel']?></td>
<td><?=$r['lokasi_hotel']?></td>
<td><?=$r['kontak_hotel']?></td>
<td><?=$r['email_hotel']?></td>
<td>Bintang <?=$r['rating_hotel']?></td>
<td>Rp <?=number_format($r['harga_hotel'],0,',','.')?></td>
<td>
