					...
					?>
						...
						?>
							<table id="sort-table" style="margin-bottom: 2px; margin-top: 7px;" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								...
								//$no_resep_farmasi
								$farm2 = $db->query("select b.nama, sum(total) as jml1, a.tgl_insert, a.qty from tbl_racikan_detail a  left join tbl_racikan b on b.id=a.racikanId where b.no_resep='" . $no_resep_farmasi . "' and a.status_delete='UD' and b.status_delete='UD' group by racikanId, a.tgl_insert", 0);
									...
									?>
										<tr>
											...
											<td style="text-align: left" colspan="2">
												<?php echo date("d-M-Y", strtotime($farm2[$i]['tgl_insert'])) ?>
											</td>
											<td style="text-align: left"><?php echo $farm2[$i]['qty'] ?></td>
											<td style="text-align: right; width: 75px;"><?php echo number_format($nilai_racikan) ?></td>
											<td style="text-align: right">
												...
												<input type="hidden" id="pharmacy[<?php echo $itr ?>][qty]" name="pharmacy[<?php echo $itr ?>][qty]" value="<?php echo $farm2[$i]['qty'] ?>" />
								...
								if ($totFarm > 0) {
									?>
									<tr>
										<th colspan="4" style="text-align: right; margin-right: 5px; font-weight: bold">Total Biaya Pharmacy</th>
										<th style="text-align: right; font-weight: bold"><?php echo number_format($totFarm) ?></th>
										<th style="text-align: right">&nbsp;</th>
									</tr>
								</tbody>
