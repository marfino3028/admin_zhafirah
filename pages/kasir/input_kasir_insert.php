<?php
	...
	// AKHIR INSERT BARU BHP
		...
		//Masukkan ke jurnal administrasi ke-1
		...
		$kd_coa = $db->query("select piutang_kd_coa, kode_perusahaan from tbl_perusahaan where kode_perusahaan='".$dataUmum[0]['kode_perusahaan']."'");
		if ($dataUmum[0]['kode_perusahaan'] == "PPP031") {
			...
			$keterangan = 'A/R Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			...
			//Jurnal Administrasi yang ke-dua
			$no_do = $db->query("select no_dokumen_nr from tbl_jurnal order by no_dokumen_nr desc");
			$nodok = $no_do[0]['no_dokumen_nr'] + 1;
			if ($nodok < 10) $nodokumen = '00000'.$nodok;
			elseif ($nodok >= 10 and $nodok < 100) $nodokumen = '0000'.$nodok;
			...
			$tanggal = date("Y-m-d");
			$statuss = 'POSTED';
			$tipe_dokumen = 'Payment From Patient';
			$petugas = $_SESSION['rg_user'];
			$mata_uang = 'Rupiah';
			$rate = 1;
			$supplier = '';
			$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
			$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
			$keterangan = 'Payment By Cash, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].' Notes: PS: '.$pasien[0]['nm_pasien'];
			...
			$coa = $db->query("select kd_coa, nm_coa, default_pos from tbl_coa where kd_coa='11020015'");
			$gl_kode = $coa[0]['kd_coa'];
			$gl_nama = $coa[0]['nm_coa'];
			//if ($coa[0]['default_pos'] == 'Debit') {
				$debit = $ttlAdmin;
			...
			$keterangan = 'Payment By Cash, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
			$deskripsi = 'Payment By Cash, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
			$dtarif = $db->query("select * from tbl_rawat where no_rawat='".$dataUmum[0]['no_rawat']."'");
			$reg_no = $_POST['nodaftar'];
			$cost_center_kode = $dtarif[0]['kd_profit'];
			$cost_center_nama = $dtarif[0]['nm_profit'];
			...
			//Masukkan ke jurnal untuk obat yang pertama
			$obatPr = $_POST['pharmacy'];
			for ($i = 0; $i < count($_POST['pharmacy']); $i++) {
				$nilai = $nilai + $_POST['pharmacy'][$i]['nilai'];
			}
			if ($nilai > 0) {
			...
			$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
			$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
			$keterangan = 'Patient Transaction:  No. Reg.'.$_POST['nodaftar'].', Resep Obat Farmasi: ['.$dokter[0]['nama_dokter'].'] PS: '.$pasien[0]['nm_pasien'];
			$deskripsi = 'A/R Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$dtarif = $db->query("select * from tbl_poli where kd_poli='".$dataUmum[0]['kd_poli']."'");
			$reg_no = $_POST['nodaftar'];
			$cost_center_kode = $dtarif[0]['kd_profit'];
			...
			if (count($_POST['prwt']) > 0) {
				//insert lab
				for ($i = 0; $i < count($_POST['prwt']); $i++) {
					$nilai_tindakan = $nilai_tindakan + $_POST['prwt'][$i]['nilai'];
				}
				...
				$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
				$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
				$keterangan = 'A/R Tindakan Medis Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
				$deskripsi = 'A/R Tindakan Medis Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
				...
				$gl_nama = $coa[0]['nm_coa'];
				if ($coa[0]['default_pos'] == 'Debit') {
					$debit = $nilai_tindakan;
					$kredit = 0;
				}
				elseif ($coa[0]['default_pos'] == 'Credit') {
					$debit = 0;
					$kredit = $nilai_tindakan;
				}
				...
				$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
				$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
				$keterangan = 'Payment By Cash Tindakan Medis, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$deskripsi = 'Payment By Cash Tindakan Medis, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$dtarif = $db->query("select * from tbl_rawat where no_rawat='".$dataUmum[0]['no_rawat']."'");
				$reg_no = $_POST['nodaftar'];
				$cost_center_kode = $dtarif[0]['kd_profit'];
				$cost_center_nama = $dtarif[0]['nm_profit'];
			...
			if (count($_POST['lab']) > 0) {
				for ($i = 0; $i < count($_POST['lab']); $i++) {
					$nilai_tindakan_lab = $nilai_tindakan_lab + $_POST['lab'][$i]['nilai'];
				}
				...
				$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
				$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
				$keterangan = 'Payment By Cash Tindakan Laboratorium, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$deskripsi = 'Payment By Cash Tindakan Laboratorium, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$dtarif = $db->query("select * from tbl_rawat where no_rawat='".$dataUmum[0]['no_rawat']."'");
				$reg_no = $_POST['nodaftar'];
				$cost_center_kode = $dtarif[0]['kd_profit'];
				$cost_center_nama = $dtarif[0]['nm_profit'];
			...
			if (count($_POST['fis']) > 0) {
				for ($i = 0; $i < count($_POST['fis']); $i++) {
					$nilai_tindakan_fis = $nilai_tindakan_fis + $_POST['fis'][$i]['nilai'];
				}
				...
				$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
				$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
				$keterangan = 'Payment By Cash Tindakan Fisiotherapi, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$deskripsi = 'Payment By Cash Tindakan Fisiotherapi, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$dtarif = $db->query("select * from tbl_rawat where no_rawat='".$dataUmum[0]['no_rawat']."'");
				$reg_no = $_POST['nodaftar'];
				$cost_center_kode = $dtarif[0]['kd_profit'];
				$cost_center_nama = $dtarif[0]['nm_profit'];
			...
			if (count($_POST['rad']) > 0) {
				for ($i = 0; $i < count($_POST['rad']); $i++) {
					$nilai_tindakan_rad = $nilai_tindakan_rad + $_POST['rad'][$i]['nilai'];
				}
				...
				$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
				$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
				$keterangan = 'Payment By Cash Tindakan Radiologi, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$deskripsi = 'Payment By Cash Tindakan Radiologi, Reg: '.$_POST['nodaftar'].', Bill: '.$_POST['no_kwitansi'].'Notes: PS: '.$pasien[0]['nm_pasien'];
				$dtarif = $db->query("select * from tbl_rawat where no_rawat='".$dataUmum[0]['no_rawat']."'");
				$reg_no = $_POST['nodaftar'];
				$cost_center_kode = $dtarif[0]['kd_profit'];
				$cost_center_nama = $dtarif[0]['nm_profit'];
			...
			//Jurnal Administrasi yang menggunakan asuransi BPJS ataupun Non BPJS
			$no_do = $db->query("select no_dokumen_nr from tbl_jurnal order by no_dokumen_nr desc");
			$nodok = $no_do[0]['no_dokumen_nr'] + 1;
			if ($nodok < 10) $nodokumen = '00000'.$nodok;
			elseif ($nodok >= 10 and $nodok < 100) $nodokumen = '0000'.$nodok;
			...
			$cost_center_kode = $dtarif[0]['kd_profit'];
			$cost_center_nama = $dtarif[0]['nm_profit'];
			$coa = $db->query("select kd_coa, nm_coa, default_pos from tbl_coa where kd_coa='".$kd_coa[0]['piutang_kd_coa']."'");
			$gl_kode = $coa[0]['kd_coa'];
			$gl_nama = $coa[0]['nm_coa'];
			$ttlAdmin = $_POST['admin'][0]['nilai'];
			if ($coa[0]['default_pos'] == 'Debit') {
			...
			//JURNAL TINDAKAN dan Konsul untuk BPJS dan asuransi
			$no_do = $db->query("select no_dokumen_nr from tbl_jurnal order by no_dokumen_nr desc");
			$nodok = $no_do[0]['no_dokumen_nr'] + 1;
			if ($nodok < 10) $nodokumen = '00000'.$nodok;
			elseif ($nodok >= 10 and $nodok < 100) $nodokumen = '0000'.$nodok;
			...
			$cost_center_kode = $dtarif[0]['kd_profit'];
			$cost_center_nama = $dtarif[0]['nm_profit'];
			$coa = $db->query("select kd_coa, nm_coa, default_pos from tbl_coa where kd_coa='11030109'");
			$gl_kode = $coa[0]['kd_coa'];
			$gl_nama = $coa[0]['nm_coa'];
			if ($coa[0]['default_pos'] == 'Debit') {
				$debit = $ttlAdmin2;
			...
			//JURNAL TINDAKAN medis untuk BPJS dan asuransi
			if (count($_POST['prwt']) > 0) {
				//insert lab
				for ($i = 0; $i < count($_POST['prwt']); $i++) {
					$nilai_tindakan = $nilai_tindakan + $_POST['prwt'][$i]['nilai'];
			...
			//JURNAL TINDAKAN LABORATORIUM untuk BPJS dan asuransi
			if (count($_POST['lab']) > 0) {
				//insert lab
				for ($i = 0; $i < count($_POST['lab']); $i++) {
					$nilai_tindakan_lab = $nilai_tindakan_lab + $_POST['lab'][$i]['nilai'];
			...
			$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
			$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
			$keterangan = 'A/R Tindakan Laboratorium Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$deskripsi = 'A/R Tindakan Laboratorium Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$ttlAdmin2 = $_POST['admin'][1]['nilai'];
			...
			//JURNAL TINDAKAN RADIOLOGI untuk BPJS dan asuransi
			if (count($_POST['rad']) > 0) {
				//insert lab
				for ($i = 0; $i < count($_POST['rad']); $i++) {
					$nilai_tindakan_rad = $nilai_tindakan_rad + $_POST['rad'][$i]['nilai'];
			...
			$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
			$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
			$keterangan = 'A/R Tindakan Radiologi Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$deskripsi = 'A/R Tindakan Radioloogi Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$ttlAdmin2 = $_POST['admin'][1]['nilai'];
			...
			//JURNAL TINDAKAN FISIOTHERAPI untuk BPJS dan asuransi
			if (count($_POST['fis']) > 0) {
				//insert lab
				for ($i = 0; $i < count($_POST['fis']); $i++) {
					$nilai_tindakan_fis = $nilai_tindakan_fis + $_POST['fis'][$i]['nilai'];
			...
			$pasien = $db->query("select nm_pasien from tbl_pasien where nomr='".$dataUmum[0]['nomr']."'");
			$dokter = $db->query("select nama_dokter, tarif_dokter from tbl_dokter where kode_dokter='".$dataUmum[0]['kode_dokter']."'");
			$keterangan = 'A/R Tindakan Fisiotherapi Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$deskripsi = 'A/R Tindakan Fisiotherapi Bill, '.$_POST['no_kwitansi'].' Reg: '.$_POST['nodaftar'].'] PS: '.$pasien[0]['nm_pasien'];
			$ttlAdmin2 = $_POST['admin'][1]['nilai'];
			...
			//Masukkan ke jurnal untuk obat yang menggunakan BPJS atau asuransi
			$obatPr = $_POST['pharmacy'];
			$nilai = 0;
			for ($i = 0; $i < count($_POST['pharmacy']); $i++) {
				$nilai = $nilai + $_POST['pharmacy'][$i]['nilai'];
