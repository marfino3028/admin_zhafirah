...
<body>
	...
	$kasir = $db->query("select * from tbl_kasir where md5(no_kwitansi)='" . $_GET['id'] . "'");
	...
	<div align="left">
		<p style="margin-left: 12px; margin-top: 2px; margin-bottom: 5px;">
			<img src="../../images/billing.png" /><br>
			Tanggal Kwitansi : <?php echo $kasir[0]['tgl_insert'] ?><br />
			No : <?php echo $kasir[0]['no_kwitansi'] ?><br>
			...
			<tr height="28">
				<td valign="middle" colspan="2">
					<div class="hastable box box-content nopadding" align="left" style="margin-left: 0; margin-right: 0; width: 100%; margin-top: 0px;">
						<?php
						$admnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='ADMINISTRASI' and payment_to='TOTAL'", 0);
						if ($admnr > 0) {
						?>
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								...
								<tbody>
									<?php
									$biayaAdmin = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='ADMINISTRASI' and payment_to='TOTAL'");
						...
						$admnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='PHARMACY' and payment_to='TOTAL'");
						...
						?>
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								...
								<tbody id="bodyPharmacy" style="display: none;">
									...
									?>
										...
										?>
											<tr>
												...
												<td style="text-align: right; width: 75px;"><?php echo number_format($farm[$i]['qty']) ?></td>
										...
										?>
											<tr>
												<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
												<td style="text-align: left; font-size: 10px;" colspan="2"><?php echo $farm2[0]['nama'] ?></td>
												<td style="text-align: right; width: 75px; font-size: 10px;"><?php echo number_format($farm2[0]['jml1']) ?></td>
												<td style="text-align: right; width: 75px; font-size: 10px;"><?php echo number_format($farm2[0]['qty']) ?></td>
											</tr>
										<?php
											$embalase = $db->queryItem("select nilai from tbl_config where kode='RACIKAN' and tahun='" . date("Y") . "'");
									...
									$totFarm = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='PHARMACY' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
											<td style="text-align: left; font-size: 10px;"><?php echo $adm[$i]['nama'] ?></td>
											<td style="text-align: right; font-size: 10px; width: 75px;"><?php echo number_format($adm[$i]['qty']) ?></td>
						...
						$tindnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='TINDAKAN' and payment_to='TOTAL'");
						if ($tindnr > 0) {
						?>
							<table width="1052" id="sort-table" style="margin-bottom: 5px; margin-top: 7px;" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								<thead>
									<tr>
										<th colspan="4" style="text-align: left">Tindakan Medis</th>
									</tr>
								</thead>
								<tbody>
									<?php
									$totTdk = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='TINDAKAN' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
									...
									<tr>
										...
										<th width="74" style="text-align: right; font-size: 10px;"><?php echo number_format($totTdk) ?></th>
									</tr>
								</tbody>
							</table>
						<?php
						}
						$alkesnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='alkes' and payment_to='TOTAL'");
						if ($alkesnr > 0) {
						?>
							<table width="1054" id="sort-table" style="margin-bottom: 5px; margin-top: 7px;">
								<thead>
									<tr>
								...
								<tbody>
									<?php
									$totAlkes = 0;
									$adm = $db->query("select * from tbl_kasir_detail where no_kwitansi='" . md5($_GET['id']) . "' and kategori='alkes' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
									...
									?>
									<tr>
										<th colspan="3" style="text-align: right; margin-right: 5px; font-size: 10px;">Total Biaya Alkes</th>
						...
						$labnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='LAB' and payment_to='TOTAL'");
						if ($labnr > 0) {
						?>
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								<thead>
									<tr>
										<th colspan="4" style="text-align: left">Laboratorium</th>
									</tr>
								</thead>
								<tbody>
									<?php
									$totLab = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='LAB' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
									...
									<tr>
										...
										<th style="text-align: right; font-size: 10px;"><?php echo number_format($totLab) ?></th>
									</tr>
								</tbody>
							</table>
						<?php
						}
						$gigi_nr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where no_kwitansi='" . md5($_GET['id']) . "' and kategori='GIGI' and payment_to='TOTAL'");
						if ($gigi_nr > 0) {
						?>
							...
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								<thead>
									<tr>
										<th colspan="4" style="text-align: left">Poli Gigi</th>
									</tr>
								</thead>
								<tbody>
									<?php
									$totgigi = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='GIGI' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
									...
									?>
									<tr>
										<th colspan="3" style="text-align: right; margin-right: 5px; font-size: 10px;">Total Biaya Poli Gigi</th>
										<th style="text-align: right; font-size: 10px;"><?php echo number_format($totgigi) ?></th>
									</tr>
								</tbody>
							</table>
						...
						$obygn_nr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='OBYGN' and payment_to='TOTAL'");
						if ($obygn_nr > 0) {
						?>
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								<thead>
									<tr>
										<th colspan="4" style="text-align: left">Poli Obygn/Kandungan</th>
									</tr>
								</thead>
								<tbody>
									<?php
									$totObygn = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='OBYGN' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
									...
									?>
									<tr>
										<th colspan="3" style="text-align: right; margin-right: 5px; font-size: 10px;">Total Biaya Poli Obygn/Kandungan</th>
										<th style="text-align: right; font-size: 10px;"><?php echo number_format($totObygn) ?></th>
									</tr>
								</tbody>
							</table>
						<?php
						}
						$bedah_nr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='BEDAH' and payment_to='TOTAL'");
						if ($bedah_nr > 0) {
						?>
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								<thead>
								...
								<tbody>
									<?php
									$totObygn = 0;
									$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='BEDAH' and payment_to='TOTAL'");
									for ($i = 0; $i < count($adm); $i++) {
									?>
										<tr>
											<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
							...
							?>
								<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
									...
									<tbody>
										<?php
										$totRad = 0;
										$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='RAD' and payment_to='TOTAL'");
										for ($i = 0; $i < count($adm); $i++) {
										?>
											<tr>
												<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
										...
										<tr>
											...
											<th style="text-align: right; font-size: 10px;"><?php echo number_format($totRad) ?></th>
										</tr>
									</tbody>
								</table>
							<?php
						...
						$fisnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='FIS' and payment_to='TOTAL'");
						if ($fisnr > 0) {
							?>
								<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
									<thead>
									...
									<tbody>
										<?php
										$totFis = 0;
										$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='FIS' and payment_to='TOTAL'");
										for ($i = 0; $i < count($adm); $i++) {
										?>
											<tr>
												<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
										...
										<tr>
											...
											<th style="text-align: right; font-size: 10px;"><?php echo number_format($totFis) ?></th>
										</tr>
									</tbody>
								</table>
							<?php
						...
						$prwtnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='PRWT' and payment_to='TOTAL'");
						if ($prwtnr > 0) {
							?>
								<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
									<thead>
										<tr>
											<th colspan="3" style="text-align: left">Keperawatan</th>
										</tr>
									</thead>
									<tbody>
										<?php
										$totFis = 0;
										$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='PRWT' and payment_to='TOTAL'");
										for ($i = 0; $i < count($adm); $i++) {
										?>
											<tr>
												<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
										...
										<?php
											$totPrwt = $totPrwt + $adm[$i]['bayar'];
										}
										?>
										<tr>
											<th colspan="2" style="text-align: right; margin-right: 5px; font-size: 10px;">Total Biaya Keperawatan</th>
											<th style="text-align: right; font-size: 10px;"><?php echo number_format($totPrwt) ?></th>
										</tr>
									</tbody>
								</table>
							<?php
						...
						$ranapnr = $db->queryItem("select sum(bayar) from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='RANAP' and payment_to='TOTAL'");
						if ($ranapnr > 0) {
							?>
								<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
									<thead>
										<tr>
											<th colspan="3" style="text-align: left">Rawat INAP</th>
										</tr>
									</thead>
									<tbody>
										<?php
										$totRanap = 0;
										$adm = $db->query("select * from tbl_kasir_detail where md5(no_kwitansi)='" . $_GET['id'] . "' and kategori='RANAP' and payment_to='TOTAL'");
										for ($i = 0; $i < count($adm); $i++) {
										?>
											<tr>
												<td style="width: 15px; text-align: right; font-size: 10px;">-</td>
										...
										<?php
											$totRanap = $totRanap + $adm[$i]['bayar'];
										}
										?>
										<tr>
											<th colspan="2" style="text-align: right; margin-right: 5px; font-size: 10px;">Total Biaya Rawat Inap</th>
											<th style="text-align: right; font-size: 10px;"><?php echo number_format($totRanap) ?></th>
										</tr>
									</tbody>
								</table>
							<?php
						...
						$total = $biayaAdmin + $totFarm + $totLab + $totRad + $totFis + $totgigi + $totTdk + $totAlkes + $totObygn + $totBedah + $totRanap + $totPrwt;
						...
						$total_bayar = $total - $kasir[0]['diskon'];
							...
							<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
								...
								<tr>
									<th style="text-align: right; margin-right: 5px; font-size: 10px; width: 180px;">Diskon</th>
								...
								<tr>
									<th colspan="3" style="text-align: left; font-size: 10px; margin-left: 15px; margin-bottom: 0px;">Terbilang : "<?php echo ucwords(Terbilang($total_bayar)) . ' Rupiah' ?>"</th>
								</tr>
						...
						<tr>
							...
							<div style="float: right; width: 200px; text-align:center">
								<p style="margin-bottom: 9px; font-size: 10px; margin-top: 0px;">Jakarta, <?php echo date("d F Y", strtotime($kasir[0]['tgl_insert'])) ?></p>
