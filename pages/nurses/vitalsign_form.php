			...
			<form action="pages/nurses/<?php echo $menuju?>" method="POST" class='form-horizontal form-bordered' enctype="multipart/form-data">
				...
				<div class="col-sm-3">
					  	<small>Berat Badan</small>
                      			  	<input type="number" class="form-control" onkeyup="hitungBMI()" id="v_weight" name="v_weight" placeholder="Weight" value="<?php echo $sub[0]['v_weight']?>">
					</div>
					<div class="col-sm-3">
						<small>Tinggi Badan</small>
						<input type="number" class="form-control" onkeyup="hitungBMI()" id="v_height" name="v_height" placeholder="Height" value="<?php echo $sub[0]['v_height']?>">
					</div>
					<div class="col-sm-3">
				...
				<div class="form-group">
					<div class="col-sm-3">
						<small>Sistolik</small>
						<input type="text" class="form-control" id="v_bp" name="v_bp" placeholder="BP Sistolik" value="<?php echo $sub[0]['v_bp']?>">
					</div>					
					<div class="col-sm-3">
						<small>BP Diastolik</small>
					...
					<div class="col-sm-3">
						<small>Frekuensi Nafas</small>
						<input type="text" class="form-control" id="v_rr" name="v_rr" placeholder="Frekuensi Nafas" value="<?php echo $sub[0]['v_rr']?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
                      	<small>Lingkar Kepala</small>
						<input type="text" class="form-control" id="lingkar_k" name="lingkar_k" placeholder="Lingkar Kepala" value="<?php echo $sub[0]['lingkar_k']?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
                      	<small>SPO2</small>
						<input type="text" class="form-control" id="spo2" name="spo2" placeholder="SPO2" value="<?php echo $sub[0]['spo2']?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
                      	<small>Skala Nyeri</small>
						<input type="text" class="form-control" id="pain_l" name="pain_l" placeholder="Skala Nyeri" value="<?php echo $sub[0]['pain_l']?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
                      	<small>Anamnesis</small>
						<input type="text" class="form-control" id="anamnesis" name="anamnesis" placeholder="Anamnesis" value="<?php echo $sub[0]['anamnesis']?>">
					</div>
				</div>
