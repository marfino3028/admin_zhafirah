<div>
    <div class="breadcrumbs">
        <ul>
            <li>
                <a href="javascript:void(0)">Worklist Nurses</a>
        ...
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-title">
					...
					?>
                    <form action="index.php?mod=nurses&submod=worklist" method="POST" class='form-horizontal form-bordered'>
                            ...
                            <div class="box box-color box-bordered box-small" style="padding-bottom: 50px!important; min-height: 300px;">
                                <div class="box-title">
                                    <h3 style="padding-right: 50px;">
                                        <i class="fa fa-table"></i> Worklist Nurses
                                    </h3>
                                    

                                </div>
                                <div class="box-content nopadding" style="min-height: 350px;">

                                    <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered" style="padding-top: 5px;">
                                        <thead>
                                        <tr>
                                          	<th>Action</th>
                                                ...
                                                <td>
													...
													<div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="index.php?mod=nurses&submod=worklist_view&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">View Pemeriksaan</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                  	<?php
                                                    ...
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <!--<a href="index.php?mod=nurses&submod=vitalsign_form&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">Input Tanda-tanda Vital</a>-->
                                                                <a href="index.php?mod=nurses&submod=vitalsign_list&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">Input Tanda-tanda Vital</a>
                                                            </li>
                                                            <li>
                                                                <a href="index.php?mod=farmasi&submod=input_resep_obat&id=<?php echo $data[$i]['resep']?>">Input Resep Elektronik</a>
                                                            </li>
                                                            <li>
                                                                <a href="pages/nurses/worklist_lab.php?id=<?php echo md5($data[$i]['resep'])?>">Input Penunjang Medis Laboratorium</a>
                                                            </li>
                                                            <li>
                                                                <a href="pages/nurses/worklist_rad.php?id=<?php echo md5($data[$i]['resep'])?>">Input Penunjang Medis Radiologi</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                  	<?php
