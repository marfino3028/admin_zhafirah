<?php
	$ceknmr = $db->queryItem("select max(right(kode, 3)*1) from tbl_logistik where left(right(kode, 7), 4)='".date("my")."'", 0);
	$ceknmr = $ceknmr + 1;
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" id="kode" name="kode" placeholder="Kode Logistik" class="form-control" value="<?php echo $nomr?>" readonly />
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="nama" name="nama" placeholder="Nama Logistik" class="form-control" tabindex="2" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
						    ...
						    ?>
                                                    ...
                                                    <div class="col-sm-5">
							<label>HNA</label>
                                                        <input type="number" id="hna" name="hna" class="form-control" tabindex="4" />
                                                    </div>
                                                    <div class="col-sm-5">
							<label>HNA + PPN <?php echo $ppn[0]['nilai'].'%'?></label>
                                                        <input type="number" id="nilai_hna" name="nilai_hna" placeholder="Terhitung secara Auto sesuai dengan PPN" class="form-control" tabindex="5" readonly />
                                                    </div>
                                                </div>
                                                <div class="form-group">
							...
							<label>Aktif</label>
							<div class="radio">
								<label><input type="radio" value="YA" id="aktif" name="aktif">Ya</label>
							</div>
							<div class="radio">
								<label><input type="radio" value="TIDAK" id="aktif" name="aktif">TIDAK</label>
							</div>
						    </div>
						    <div class="col-sm-5">
							<label>Tipe Stock</label>
							<div class="radio">
								<label><input type="radio" value="STOCK" id="tipe_stok" name="tipe_stok">Stock</label>
							</div>
							<div class="radio">
								<label><input type="radio" value="NON" id="tipe_stok" name="tipe_stok">Non Stock</label>
							</div>
						    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Master Logistik" onclick="simpanData(this.form, 'pages/master/logistik_insert.php')" tabindex="15" />
                                        </div>
                                    </form>
                                </div>
                            </div>
