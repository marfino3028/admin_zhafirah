                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control" /> Format mm/dd/yyyy
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <button onclick="cekNik()" type="button" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-search"></i> Cek NIK</button>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-actions">
                                                    <input type="button" disabled name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Master Pasien" onclick="simpanData(this.form, 'pages/master/pasien_insert.php')" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script language="javascript">
    ...
    function cekNik() {
        ...
        $.ajax({
            ...
            method: "POST",
            data: {
                jenis_query: "Cek NIK Master Pasien",
                no_ktp: no_ktp
            },
            dataType: "json",
            async: true,
            success: function(data) {
                if (data.jumlahData > 0) {
                    Swal.fire({
                        ...
                        text: 'NIK ' + no_ktp + ' sudah terdaftar dengan MR ' + data.body[0].nomr + ' : ' + data.body[0].nm_pasien,
                        icon: 'warning',
                        confirmButtonText: 'OK'
                    });
                    document.getElementById("simpan").value = 'Double NIK'
                    document.getElementById("simpan").disabled = true
                } else {
                    document.getElementById("simpan").value = 'Simpan Data Master Pasien'
