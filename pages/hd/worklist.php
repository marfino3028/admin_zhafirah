        ...
        <div class="col-sm-12">
            <div class="box">
              <div class="box-title">
                ...
                <a href="index.php?mod=hd&submod=worklist_form_hd&id=<?php echo md5($_GET['id']).'&ids='.md5($_GET['ids'])?>" class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Input Pemeriksaan</a>
                <a href="index.php?mod=hd&submod=worklist_phr&id=<?php echo md5($_GET['id']).'&ids='.md5($_GET['ids'])?>" class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Upload PHR</a>
              </div>
