                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div id="DataAdd">
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="List Pasien Layanan Hemodialisa" onclick="simpanData(this.form, 'index.php?mod=hd&submod=hd')" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                        ...
                                                        <table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin">
                                                            ...
                                                            for ($i = 0; $i < count($data); $i++) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><a class="btn_no_text btn" style="border-radius: 4px;" title="Delete" href="#" onclick="return window.location = 'pages/hd/hd_delete.php?id=<?php echo $data[$i]['id'].'&subid='.$_GET['id']?>';"> <span class="ui-icon ui-icon-circle-close"></span> </a> </td>
                                                                </tr>
                                                                <?php
