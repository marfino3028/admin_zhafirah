                ...
                <div align="left" style="margin-top: 20px; width: 270px; overflow: inherit">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="270" bordercolor="#000000">
                        ...
                        <tr height="28">
                            ...
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            <select id="hub" name="hub" size="1" style="width: 140px;">
                        ...
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">&nbsp;</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            <select id="hub_nomr" name="hub_nomr" size="1" style="width: 140px;">
								<option value="">--Nama Pegawai--</option>
                                <?php
									$poli = $db->query("select nomr, nm_keluarga from tbl_pasien where status_delete='UD' and hub='PEGAWAI' and nm_keluarga <> '' order by nm_keluarga");
									for ($i = 0; $i < count($poli); $i++) {
										echo '<option value="'.$poli[$i]['nomr'].'">'.$poli[$i]['nm_keluarga'].'</option>';
									}
								?>
								<option value="ANAK">ANAK</option>
                            </select>
