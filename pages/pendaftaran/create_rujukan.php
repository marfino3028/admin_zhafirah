                            ...
                            <div class="box box-color box-bordered box-small blue">
                                <div class="box-title">
                                    <h3>
                                        ...
                                        Form Pembuatan Rujukan : <span id="rujukKe"></span> - <span id="poliRujukKe"></span>
                                    </h3>
                                    ...
                                    <div class="row" style="margin-top: 5px;">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"><b>Nomor SEP</b></span>
                                                <input type="text" class="form-control" id="noSep" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"><b>Tanggal Rujukan</b></span>
                                                <input type="date" class="form-control" value="<?= date('Y-m-d'); ?>" id="tglRujukan">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
...
<?php
include "pages/pendaftaran/lib_sep/create_rujukan_js.php";
?>