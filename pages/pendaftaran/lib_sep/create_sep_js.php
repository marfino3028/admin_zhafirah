    ...
    function getPendaftaran() {
        ...
        $.ajax({
            ...
            success: function(data) {
                document.getElementById("noKartu").value = data[0].no_peserta
                document.getElementById("noMR").value = data[0].nomr
                document.getElementById("noTelp").value = data[0].telp_pasien
            }
        });
    }
