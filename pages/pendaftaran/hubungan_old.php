...
<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<div class="button float-right">
							...
							<a href="index.php?mod=master&submod=pasien_new"  class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Tambah Data Pasien</a>
						</div>
                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
                        ...
                        <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
                            ...
                            <?php
								...
								if ($_POST['search'] == "") 
									$data_nr = $db->queryItem("select count(id) from tbl_keluarga where status_delete='UD'", 0);
								else 
									$data_nr = $db->queryItem("select count(id) from tbl_keluarga where hubungan like '%".$_POST['search']."%' and status_delete='UD'", 0);
								$nrdata = $data_nr;
                                ...
                                if ($_POST['search'] == "") 
									$data = $db->query("select * from tbl_keluarga where status_delete='UD' order by id", 0);
								else
									$data = $db->query("select * from tbl_keluarga where hubungan like '%".$_POST['search']."%' and status_delete='UD' order by id", 0);
