                                    ...
                                    <div class="row" style="margin-top: 5px;">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="noKartu" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"><b>Tanggal SEP</b></span>
                                                <input type="date" class="form-control" value="<?= date('Y-m-d'); ?>" id="tglSep">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
                                    ...
                                    <div class="row" style="margin-top: 5px;">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" autocomplete="off" id="noRujukan">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="date" value="<?= date('Y-m-d'); ?>" class="form-control" id="tglRujukan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 5px;">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="ppkRujukan" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group">
...
<?php
include "pages/pendaftaran/lib_sep/create_sep_js.php";
?>