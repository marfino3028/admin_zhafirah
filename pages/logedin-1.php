<?php
	...
	$data = $db->query("select userid, sandi, nip, nama, code, user_shift  from tbl_user where userid='".$username."' and sandi='".md5($password)."'", 1);
	...
	//echo "login($username, $password, $data[0]['sandi'], $data[0]['nama'], $data[0]['nip'], $data[0]['code'], $shiftUser)";
	if ($loginArea == 0) {
