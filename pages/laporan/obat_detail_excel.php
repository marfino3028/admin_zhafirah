<?php
	...
	header("Content-Disposition: attachment; filename=Laporan2.xls");
?><div>
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                            ...
                            <div class="box box-color box-bordered box-small" style="padding-bottom: 50px!important;">
                                ...
                                <div class="box-content nopadding" style="overflow-x:auto;">
                                    ...
                                    <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
                                        ...
                                        <tbody>
                                        <?php
					     $data = $db->query("select a.tgl_daftar, a.id, a.nomr, a.yang_berobat, b.nip, b.dept_nama, b.nm_pasien nama, a.no_daftar from tbl_pendaftaran a left join tbl_pasien b on b.nomr=a.nomr where a.status_delete='UD' and a.tgl_daftar >= '".$_POST['d11']."' and a.tgl_daftar <= '".$_POST['d12']."' order by a.id desc", 0);
