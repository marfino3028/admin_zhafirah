<?php
	...
	$insert = $db->query("insert into tbl_racikan_detail (racikanId, kode_obat, nama_obat, qty, harga, total) values ('".$_POST['racikan']."', '".$_POST['obat']."', '".$obt[0]['nama_obat']."', '".$_POST['qty']."', '".$obt[0]['harga_jual']."', '".$total."')");
?>
