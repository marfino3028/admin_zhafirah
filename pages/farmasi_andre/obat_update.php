<?php
	...
	if ($_SESSION['rg_user'] != '') {
		...
		$insert = $db->query("update tbl_obat set kode_obat='".$_POST['kode_obat']."', nama_obat='".$_POST['nama_obat']."', jenis='".$_POST['jenis']."', satuan_terkecil='".$satuan."', stock_awal='".$_POST['stock_awal']."', stock_akhir='".$_POST['stock_akhir']."', stock_awal='".$_POST['stock_awal']."', vendor_id='".$_POST['vendor']."', vendor='".$vendorid."', suplier_id='".$_POST['suplier']."', vendor='".$suplierid."', harga_beli='".$_POST['harga_beli']."', harga_jual='".$_POST['harga_jual']."', expire_date='".$tanggal."', harga_per_box='".$_POST['harga_per_box']."', jml_per_box='".$_POST['jml_per_box']."', stock_min_apotik='".$_POST['stock_min_apotik']."', stock_min_gudang='".$_POST['stock_min_gudang']."', stock_min='".$_POST['stock_min']."' where id='".$_POST['id']."'", 0);
	}
