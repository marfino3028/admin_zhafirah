...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Resep Pasien Jamsostek</div>
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="210" bordercolor="#000000">
                        <tr height="28">
                            ...
                            <input type="text" id="no_resep" name="no_resep" class="form-control" style="width: 117px; background-color:#CCC" value="<?php echo $nomr?>" readonly="readonly" />
                            </div></td>
                        </tr>
                        <tr height="28">
                            ...
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            	<select id="nodaftar" name="nodaftar" size="1" style="width: 130px;" onchange="CariPasien(this.value)">
									<option value="">--No KPJ--</option>
									<?php
										$daft = $db->query("select idNomr, no_daftar, nomr from tbl_pendaftaran_jamsostek where status_pasien='OPEN' and status_delete='UD'");
										for ($i = 0; $i < count($daft); $i++) {
											$nama = $db->queryItem("select nm_pasien from tbl_pasien_jamsostek where id='".$daft[$i]['idNomr']."'");
											echo '<option value="'.$daft[$i]['no_daftar'].'###'.$daft[$i]['idNomr'].'">'.$daft[$i]['nomr'].'-'.$nama.'</option>';
										}
									?>
								</select>
                            </div></td>
                        ...
                        <tr height="28">
                            ...
                            <span style="margin-left:10px; margin-bottom: 2px; margin-top: 10px;">Diagnosa</span>
							<div style="margin-bottom: 4px; margin-top: 5px; margin-left: 15px;">
                            <textarea id="diagnosa" name="diagnosa" rows="6" cols="22"></textarea>
                            </div></td>
                        </tr>
                        <tr height="28">
