...
$catatan = $db->query("select * from tbl_catatan_dktr_hd where no_daftar='" . $_GET['no_daftar'] . "'");
...
<div style="padding: 10px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
    <table style="width: 100%;">
        <tr valign="top">
            <td style="text-align: center;"><img src="../../images/billing_1.png" height="55px"></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td>
    ...
    &nbsp; <label style="color: blue; font-size: 14pt;">Informasi HD</label>
