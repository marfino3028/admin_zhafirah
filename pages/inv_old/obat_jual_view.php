                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
					<table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
						...
						<?php
							...
							if ($_POST['metode'] == 'ALL') {
								$data = $db->query("select kode_obat, nama_obat, sum(qty) as qtys, harga_jual, harga_beli from lap_hpp where tgl_bayar >= '$date1' and tgl_bayar < '$date2' and metode_payment IN ('CASH', 'ASS', 'CC', 'DEBIT') group by kode_obat", 0);
							}
							else {
