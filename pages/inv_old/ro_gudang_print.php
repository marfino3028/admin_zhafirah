...
<div align="left">
	...
	<p style="margin-left: 12px; margin-top: 2px; margin-bottom: 5px;">
		Nomor Permintaan : <?php echo $ro[0]['no_ro_gudang']?><br />
		Tanggal Input : <?php echo date("d-m-Y", strtotime($ro[0]['tgl_input_ro_gudang']))?><br />
				...
				<div class="hastable box box-content nopadding" align="left" style="margin-left: 10px; margin-right: 10px; width: 100%">
					<table id="table-data" class="table table-hover table-nomargin dataTable table-bordered nomargin"> 
						...
						<tr>
							...
							<th style="text-align: center" rowspan="2">Jumlah<br />Permintaan</th> 
						</tr> 
						<tr>
