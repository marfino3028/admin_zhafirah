...
<div class="page-title ui-widget-content ui-corner-all">
					<h1>PERMINTAAN OBAT DARI CLINIC KE PUSAT
</h1>
					<div class="other">
						<div class="float-left">Permintaan Obat.</div>
                        ...
                        <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn_no_text btn" style="border-radius: 4px;" title="Edit" href="index.php?mod=inv&submod=input_ro_detail&id=<?php echo $data[$i]['id']?>">
