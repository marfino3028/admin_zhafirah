...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Permintaan Obat dari Apotik ke Gudang</div>
        ...
        <table border="1" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#000000">
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="250" bordercolor="#000000">
                        <tr height="28">
                            <td width="120"><span style="margin-left:10px " style="width:10">No. Request</span></td>
                        ...
                        <tr height="28">
                            <td width="120"><span style="margin-left:10px">Tanggal Request</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                        ...
                        <tr height="28">
                            <td width="120"><span style="margin-left:10px">Unit</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
