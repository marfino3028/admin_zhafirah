...
<div class="page-title ui-widget-content ui-corner-all">
					<h1>Data Master:<b> Pasien</b></h1>
					<div class="other">
						<div class="float-left">Insert, Update, Delete Data Master Pasien.</div>
						<div class="button float-right">

							<a href="index.php?mod=master&submod=pasien_new&id=<?php echo $data[$i]['id']?>"  class="btn btn-sm btn-small btn-darkblue rounded pull-right"><span class="fa fa-plus-circle"></span> Tambah Data Pasien</a>
						</div>
             ...
             <div class="box box-color box-bordered box-small" style="padding-bottom: 50px!important;">
                ...
                <div class="box-content nopadding" style="overflow-x:auto;">
                        ...
                        <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered">
                            ...
                            <tbody> 
                            <?php
                                $data = $db->query("select * from tbl_pasien where status_delete='UD' and nm_pasien like '%".$_POST['id']."%' order by id desc limit 5000", 0);
