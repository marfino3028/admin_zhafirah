<?php
$data=$db->query("SELECT*FROM tbl_karyawan ORDER BY tanggal_lahir DESC");
?>
<style>
...
<div class="table-section">
    <a href="?mod=karyawan&submod=add" class="btn-add">➕ Tambah Karyawan</a>
    ...
    <table class="custom-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$tgl?></td>
                <td><?=$umur?> th</td>
                <td>Rp <?=number_format($r['gaji'],0,',','.')?></td>
