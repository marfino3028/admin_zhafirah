<div class="box box-color box-bordered box-small blue">
    <div class="box-title">
        <h3>
            ...
            Form Tambah Modul Medical Check Up (MCU)
    </div>
    <div class="box-content nopadding">
        <form action="pages/mcu/module_insert.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered form-column" name="form_karyawan" id="form_karyawan" >
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="kategori_komponen" name="kategori_komponen" required="required">
                                ...
                                <option value="Biaya Pemakaian Peralatan">Biaya Pemakaian Peralatan</option>
			    ...
			    <small>Tarif Dokter</small>
                            <input type="number" id="dokter" name="dokter" placeholder="Tarif Dokter" class="form-control" required="required" onkeyup="pilih_total()" />
                        </div>
                        <div class="col-sm-3">
			    <small>Tarif Rumah Sakit</small>
                            <input type="number" id="rs" name="rs" placeholder="Tarif Rumah Sakit" class="form-control" required="required" onkeyup="pilih_total()" />
                        </div>
                        <div class="col-sm-4">
			    <small>Total Tarif</small>
                            <input type="number" id="total" name="total" placeholder="Total Tarif" class="form-control" required="required" readonly />
                        </div>
                    </div>
                    <div class="form-group">
			    ...
			    <small>Komponen</small>
                        ...
                        <div class="col-sm-2">
			    <small>Urutan</small>
                            <input type="number" id="urutan" name="urutan" placeholder="Urutan" class="form-control" required="required" />
                        </div>
                        <div class="col-sm-4">
			    <div class="col-sm-12">
...
<div class="form-check">
  <input class="form-check-input" type="radio" name="butuhdokter" id="flexRadioDefault1" value="YA" checked>
...
<div class="form-check">
  <input class="form-check-input" type="radio" name="butuhdokter" id="flexRadioDefault2" value="TIDAK">
  <label class="form-check-label" for="flexRadioDefault2">
    TIDAK
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="keterangan" id="keterangan" class="form-control" rows="4" placeholder="Keterangan untuk Modul ini"></textarea>
                        </div>
                    </div>
