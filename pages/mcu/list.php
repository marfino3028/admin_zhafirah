        ...
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-title">
					...
					?>
                    <form action="index.php?mod=mcu&submod=list" method="POST" class='form-horizontal form-bordered'>
                            ...
                            <div class="box box-color box-bordered box-small" style="padding-bottom: 70px!important; min-height: 390px;">
                                <div class="box-title">
                                    <h3 style="padding-right: 90px;">
                                        <i class="fa fa-table"></i> Worklist Dokter Layanan MCU
                                    </h3>
                                ...
                                <div class="box-content nopadding" style="min-height: 390px;">
                                    ...
                                    <table id="table-data" class="table table-hover table-responsive table-nomargin dataTable table-bordered" style="padding-top: 15px;">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width:70px">Tgl.Kunjungan</th>
                                            <th>Nama Perusahaan</th>
                                            <th>Dokter</th>
                                            <th style="width:270px">Paket MCU</th>
                                        ...
                                        <?php
                                        if ($_POST['metode'] == "" or $_POST['metode'] == "ALL") {
                                            $data = $db->query("select a.no_daftar, a.nomr, a.tgl_daftar, a.kode_dokter, a.id, a.status_pasien, a.nama_perusahaan, a.biayaAdmin, a.kd_poli, a.yang_berobat from tbl_pendaftaran a where a.status_delete='UD' and kd_poli='MC01' and a.tgl_daftar >= '".$_POST['d1']."' and a.tgl_daftar <= '".$_POST['d2']."' order by a.id desc", 0);
                                        }
                                        else {
                                            $data = $db->query("select a.no_daftar, a.nomr, a.tgl_daftar, a.kode_dokter, a.id, a.status_pasien, a.nama_perusahaan, a.biayaAdmin, a.kd_poli, a.yang_berobat from tbl_pendaftaran a where a.status_delete='UD' and kd_poli='MC01' and a.status_pasien='".$_POST['metode']."' and a.tgl_daftar >= '".$_POST['d1']."' and a.tgl_daftar <= '".$_POST['d2']."' order by a.id desc", 0);
                                        }
                                        ...
                                        for ($i = 0; $i < count($data); $i++) {
                                            ...
                                            if ($dokter == "")	{
                                            	$dktrmcu = $db->query("select dokter_nama, dokter_kode from tbl_mcu_daftar where no_daftar='".$data[$i]['no_daftar']."'", 0);
                                            	$data[$i]['kode_dokter'] = $dktrmcu[0]['dokter_kode'];
                                            	$dokter = $dktrmcu[0]['dokter_nama'];
                                            }
                                         ...
                                         ?>
                                            <tr>
                                                <td>
													...
													<div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="index.php?mod=hd&submod=worklist_view&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">View Pemeriksaan</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                  	<?php
                                                    ...
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="index.php?mod=mcu&submod=worklist&id=<?php echo $data[$i]['nomr'].'&ids='.$data[$i]['no_daftar']?>">Input Pemeriksaan MCU</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li><a href="pages/download/mcu.php?id=<?php echo md5($data[$i]['no_daftar'])?>" target="_blank">Hasil MCU</a></li>
                                                ...
                                                <td>
													<?php
														$mcu_data = $db->query("select mcupaket, mcupaket_nama from tbl_mcu_daftar where no_daftar='".$data[$i]['no_daftar']."' and nomr='".$data[$i]['nomr']."' and status_digunakan='YES'");
														echo '<b><u>'.$mcu_data[0]['mcupaket'].'</b></u>:<br>';
														for ($k = 0; $k < count($mcu_data); $k++) {
															echo '- '.$mcu_data[$k]['mcupaket_nama'].'<br>';
														}
													?>
                                                </td>
