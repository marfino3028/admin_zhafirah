<?php
	...
	$ceknmr = $db->queryItem("select max(right(no_bedah, 3)*1) from tbl_bedah where left(right(no_bedah, 11), 8)='".date("dmY")."'", 0);
	$ceknmr = $ceknmr + 1;
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Transaksi Poli Bedah </div>
           ...
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="210" bordercolor="#000000">
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">No. Bedah</span></td>
                        ...
                        <tr height="28">
                            ...
                            <div style="margin-bottom: 14px; margin-top: 14px; margin-left: 15px;">
                             <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Poli Bedah" onclick="simpanData(this.form, 'pages/poli/input_bedah_insert.php')" />
                            </div></td>
                        </tr>
                    </table>
                </div>
