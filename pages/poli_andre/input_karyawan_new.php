...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Transaksi Poli Karyawan </div>
           ...
           <tr height="28">
                ...
                <div align="left" style="margin-top: 20px;">
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="260" bordercolor="#000000">
                        <tr height="28">
                            <td width="160"><span style="margin-left:10px">No. Polkar</span></td>
                        ...
                        <tr height="28">
                            <td width="110"><span style="margin-left:10px">NoMR Karyawan</span></td>
                            <td valign="middle" align="center">
                            <div style="margin-bottom: 4px; margin-top: 4px;">
                            	<select id="nodaftar" name="nodaftar" size="1" style="width: 130px;" onchange="CariKaryawan(this.value)">
