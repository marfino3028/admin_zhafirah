<?php
	...
	$ceknmr = $db->queryItem("select max(right(no_moist, 3)*1) from tbl_moist where left(right(no_moist, 11), 8)='".date("dmY")."'", 0);
	$ceknmr = $ceknmr + 1;
...
<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
    <div class="portlet-header ui-widget-header">Form Tambah Data Transaksi Poli Moist </div>
                    ...
                    <table border="1" cellpadding="0" style="border-collapse: collapse" width="210" bordercolor="#000000">
                        ...
                        <tr height="28">
                            ...
                            <div style="margin-bottom: 14px; margin-top: 14px; margin-left: 15px;">
                             <input type="button" name="simpan" id="simpan" class="btn btn-sm btn-small btn-primary rounded" value="Simpan Data Poli Moist" onclick="simpanData(this.form, 'pages/poli/input_moist_insert.php')" />
                            </div></td>
                        </tr>
                    </table>
                </div>
