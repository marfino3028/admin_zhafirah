<?php
// Get list paket keberangkatan untuk filter
...
if(isset($_POST['id_paket_keberangkatan']) && $_POST['id_paket_keberangkatan'] != '') {
    ...
    $where .= " AND pu.id_paket_keberangkatan = '$id_paket'";
}

// Get total pengeluaran umroh
$total = $db->query("SELECT COALESCE(SUM(pu.jumlah), 0) as total 
    FROM tbl_pengeluaran_umroh pu
    LEFT JOIN tbl_paket_keberangkatan pk ON pu.id_paket_keberangkatan=pk.id
    $where");

// Get data pengeluaran umroh
$data = $db->query("SELECT pu.*, pk.nama_paket, pk.kode_keberangkatan
    FROM tbl_pengeluaran_umroh pu
    LEFT JOIN tbl_paket_keberangkatan pk ON pu.id_paket_keberangkatan=pk.id
    $where 
    ORDER BY pu.tanggal_pengeluaran DESC");
?>
...
<div class="row">
        ...
        <div class="filter-section">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    <label class="form-label">Nama Keberangkatan Umroh <span style="color:red;">*</span></label>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-label">Total Pengeluaran Umroh</div>
        </div>
    </div>
</div>
