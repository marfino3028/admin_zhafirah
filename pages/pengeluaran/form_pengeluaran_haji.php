...
<div class="content">
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="text-white pb-2 fw-bold"><?php echo isset($pengeluaran) ? 'Edit' : 'Tambah'; ?> Data Pengeluaran Haji</h2>
                    <h5 class="text-white op-7 mb-2">Kelola Data Pengeluaran Haji</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page-inner mt--5">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="haji.php">Data Pengeluaran Haji</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo isset($pengeluaran) ? 'Edit' : 'Tambah'; ?> Data Pengeluaran Haji</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <a href="haji.php<?php echo $id_keberangkatan ? '?id='.$id_keberangkatan : ''; ?>" class="btn btn-warning">
                    <i class="fas fa-arrow-left"></i> Kembali
                </a>
                <button type="button" class="btn btn-primary" onclick="document.getElementById('formPengeluaran').submit();">
                    <i class="fas fa-save"></i> Tambah Pengeluaran Haji
                </button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <form action="proses_pengeluaran_haji.php" method="post" id="formPengeluaran" enctype="multipart/form-data">
                            
                            <!-- Section: Data Keberangkatan Haji -->
                            <div class="section-header text-center mb-4 p-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px;">
                                <h4 class="mb-0" style="font-weight: 600;">Data Keberangkatan Haji</h4>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Keberangkatan Haji <span class="text-danger">*</span></label>
                                <div class="col-md-9">
                            ...
                            <!-- Section: Data Pengeluaran Haji -->
                            <div class="section-header text-center mb-4 p-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px;">
                                <h4 class="mb-0" style="font-weight: 600;">Data Pengeluaran Haji</h4>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="kode_pengeluaran" id="kode_pengeluaran"
                                           value="<?php echo isset($pengeluaran->kode_pengeluaran) ? $pengeluaran->kode_pengeluaran : 'CH-'; ?>" 
                                           placeholder="CH-" required readonly style="background-color: #e9ecef;">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    <a href="haji.php<?php echo $id_keberangkatan ? '?id='.$id_keberangkatan : ''; ?>" class="btn btn-secondary">
