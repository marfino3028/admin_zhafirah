...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title" style="font-weight: bold; font-size: 10pt;">Stock Opname Final</h4>
    </div>
    <div class="panel-body" style="background-color: #ecf1f6ff;">
        ...
        <form style="margin-bottom:15px;" onsubmit="btnSimpan.disabled = true; return true;"
            action="pages/stok_opname/model/cari_so_final.php" method="POST">
            <div class="row">
                <div class="col-md-2">
                    <label>Gudang</label>
                ...
                <div class="col-md-2">
                    ...
                    <select id="instatus_so" name="instatus_so" class="form-control input-sm">
                        ...
                        <option value="1" disabled>Open</option>
                        <option value="2" disabled>Draft</option>
                        <option selected value="3">Final</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <table class="table table-bordered table-striped table-condensed table-hover">
                    ...
                    <tbody>
                        ...
                        if (isset($kd_wh)) {
                            ...
                            $sql = "SELECT d.* FROM tbl_so_detail d INNER JOIN tbl_so_header h ON d.id_header = h.id_so WHERE 1=1 AND DATE(h.date_created) = '$tgl' AND d.status_so IN ('2', '3')";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" autocomplete="off" <?= $readonly; ?>
                                            ...
                                            class="input_">
                                        <input type="text" value="3" hidden id="status_so_<?= $row['id_detail']; ?>"
