...
<table style="font-size:9px;">
    <tr class="tr" style="background-color: #1e3c72; color: #fff;">
        ...
        <th class="th" style="width: 10%;">Jenis</th>
        <th class="th" style="width: 10%;">Satuan Kecil</th>
        <th class="th" style="width: 23%;">St.Fisik</th>
    ...
    <tr class="tr">
        ...
        <td class="td" style="width: 10%;"><?= $row['jenis']; ?></td>
        <td class="td" style="width: 10%;"><?= $row['satuan_terkecil']; ?></td>
        <td class="td" style="width: 23%;"></td>
        <td class="td" style="width: 7%;"></td>
    </tr>
    <?php
    endwhile;
    ?>
